 ...
 */
class ParentknowledgeController   extends AppController
{
     ...
     */
            ...
            public function viewcommunity()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'parentknowledge/view/'. md5($content['id']) .'" class="viewknow" >
                        '.
                        $img.'
            ...
            public function viewtechnologies()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'parentknowledge/viewnewtechnologies/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
			...
			public function viewscholar()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'parentknowledge/viewscholarship/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewintensive()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'parentknowledge/viewintensiveenglish/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewintern()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'parentknowledge/viewinternship/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewmentor()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'parentknowledge/viewmentorship/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewhowworks()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'parentknowledge/viewhowitworks/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewleader()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'parentknowledge/viewleadership/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewmachine()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'parentknowledge/viewmachinelearning/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
			...
			public function viewstateexam()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'parentknowledge/viewexamstate/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
        ...
        return $this->json($res);
            ...
            public function titlefilter()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                                    <a href="'. $this->base_url.'parentknowledge/view/'. md5($content['id']) .'" class="viewknow" target="_blank">
                                    '. $img.'
                                    <div class="set_icon">'.$icon.'</div>
                                    <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                                    '.$clsse.'</p>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'parentknowledge/viewhowitworks/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                            <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                                    '.$clsse.'</p>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'parentknowledge/viewmachinelearning/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                            <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                                    '.$clsse.'</p>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'parentknowledge/viewintensiveenglish/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                            <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                                    '.$clsse.'</p>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'parentknowledge/viewexamstate/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                            <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                                    '.$clsse.'</p>
            ...
            public function etitlefilter()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'parentknowledge/viewscholarship/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                            <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
    						</a>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'parentknowledge/viewleadership/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                             <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
    						</a>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'parentknowledge/viewmentorship/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                             <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
    						</a>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'parentknowledge/viewinternship/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                             <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
    						</a>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'parentknowledge/viewnewtechnologies/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                             <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
    						</a>
