    				...
    				if(!empty($_POST))
                    {
                        ...
                        $attdate = date("Y-m-d", strtotime($this->request->data('choosedate')));
                            ...
                            foreach($retrieve_stdnt as $stdnt)
                            {
                                ...
                                $retrieve_attndnc = $attndnc_table->find()->where(['class_id' => $classid, 'date' => $attdate, 'student_id' => $stdnt['id'] ])->first() ;
				        
        				        $stdnt->attendance = $retrieve_attndnc->title;
        				        $stdnt->attdate = $retrieve_attndnc->date;
