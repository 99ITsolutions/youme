        ...
        return $this->json($res);
            ...
            public function titlefilter()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                                    <a href="'. $this->base_url.'Kinderknowledge/view/'. md5($content['id']) .'" class="viewknow" target="_blank">
                                    '. $img.'
                                    <div class="set_icon">'.$icon.'</div>
                                    <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                                    '.$clsse.'</p>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'Kinderknowledge/viewhowitworks/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                            <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                                    '.$clsse.'</p>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'Kinderknowledge/viewmachinelearning/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                            <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                                    '.$clsse.'</p>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'Kinderknowledge/viewintensiveenglish/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                            <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                                    '.$clsse.'</p>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'Kinderknowledge/viewexamstate/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                            <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                                    '.$clsse.'</p>
            ...
            public function etitlefilter()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'Kinderknowledge/viewscholarship/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                            <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
    						</a>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'Kinderknowledge/viewleadership/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                             <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
    						</a>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'Kinderknowledge/viewmentorship/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                             <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
    						</a>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'Kinderknowledge/viewinternship/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                             <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
    						</a>
                    ...
                    {
                        $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'Kinderknowledge/viewnewtechnologies/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                            $img.'
                            <div class="set_icon">'.$icon.'</div>
                             <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
    						</a>
