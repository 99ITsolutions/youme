 ...
 */
class StudentknowledgeController   extends AppController
{
     ...
     */
            ...
            public function communityactivity($addedfor)
            {
                ...
                //print_r($retrieve_knowtitle); die();
            ...
            public function viewcommunity()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'studentknowledge/view/'. md5($content['id']) .'" class="viewknow" >
                        '.
                        $img.'
            ...
            public function viewtechnologies()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'Studentknowledge/viewnewtechnologies/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
			...
			public function viewscholar()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'Studentknowledge/viewscholarship/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewintensive()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'Studentknowledge/viewintensiveenglish/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewintern()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'Studentknowledge/viewinternship/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewmentor()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'Studentknowledge/viewmentorship/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewhowworks()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'Studentknowledge/viewhowitworks/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewleader()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'Studentknowledge/viewleadership/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
			...
			public function viewmachine()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'Studentknowledge/viewmachinelearning/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
			...
			public function viewstateexam()
            {
                ...
                foreach($retrieve_know as $content)
                {
                    ...
                    $res .= '<div class="col-sm-2 col_img">
                        <a href="'. $this->base_url.'Studentknowledge/viewexamstate/'. md5($content['id']) .'" class="viewknow" >'.
                        $img.'
                        <div class="set_icon">'.$icon.'</div>
						</a>
						<p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
    ...
    public function titlefilter()
    {
        ...
        foreach($retrieve_know as $content)
        {
            ...
            {
                $res .= '<div class="col-sm-2 col_img">
                            <a href="'. $this->base_url.'Studentknowledge/view/'. md5($content['id']) .'" class="viewknow" target="_blank">
                            '. $img.'
                            <div class="set_icon">'.$icon.'</div>
                            <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                            '.$clsse.'</p>
            ...
            {
                $res .= '<div class="col-sm-2 col_img">
                    <a href="'. $this->base_url.'Studentknowledge/viewhowitworks/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                    $img.'
                    <div class="set_icon">'.$icon.'</div>
                    <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                            '.$clsse.'</p>
            ...
            {
                $res .= '<div class="col-sm-2 col_img">
                    <a href="'. $this->base_url.'Studentknowledge/viewmachinelearning/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                    $img.'
                    <div class="set_icon">'.$icon.'</div>
                    <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                            '.$clsse.'</p>
            ...
            {
                $res .= '<div class="col-sm-2 col_img">
                    <a href="'. $this->base_url.'Studentknowledge/viewintensiveenglish/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                    $img.'
                    <div class="set_icon">'.$icon.'</div>
                    <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                            '.$clsse.'</p>
            ...
            {
                $res .= '<div class="col-sm-2 col_img">
                    <a href="'. $this->base_url.'Studentknowledge/viewexamstate/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                    $img.'
                    <div class="set_icon">'.$icon.'</div>
                    <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</br>
                            '.$clsse.'</p>
    ...
    public function etitlefilter()
    {
        ...
        foreach($retrieve_know as $content)
        {
            ...
            {
                $res .= '<div class="col-sm-2 col_img">
                    <a href="'. $this->base_url.'Studentknowledge/viewscholarship/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                    $img.'
                    <div class="set_icon">'.$icon.'</div>
                    <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
					</a>
            ...
            {
                $res .= '<div class="col-sm-2 col_img">
                    <a href="'. $this->base_url.'Studentknowledge/viewleadership/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                    $img.'
                    <div class="set_icon">'.$icon.'</div>
                     <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
					</a>
            ...
            {
                $res .= '<div class="col-sm-2 col_img">
                    <a href="'. $this->base_url.'Studentknowledge/viewmentorship/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                    $img.'
                    <div class="set_icon">'.$icon.'</div>
                     <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
					</a>
            ...
            {
                $res .= '<div class="col-sm-2 col_img">
                    <a href="'. $this->base_url.'Studentknowledge/viewinternship/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                    $img.'
                    <div class="set_icon">'.$icon.'</div>
                     <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
					</a>
            ...
            {
                $res .= '<div class="col-sm-2 col_img">
                    <a href="'. $this->base_url.'Studentknowledge/viewnewtechnologies/'. md5($content['id']) .'" class="viewknow" target="_blank">'.
                    $img.'
                    <div class="set_icon">'.$icon.'</div>
                     <p class="title" style="color:#000"><b>Titre</b>: '. ucfirst($content->title) .'</p>
					</a>
