 ...
 */
class LibraryAccessReportController extends AppController
{
    ...
    { 
        ...
        $retrieve_schools = $school_table->find()->where(['status' => 1])->order(['comp_name' => 'ASC'])->toArray();
