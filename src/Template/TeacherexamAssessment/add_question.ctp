                            ...
                            <div class="row">
                                <h3 class="col-md-9  align-left ">
                                    <div class="col-sm-4" style="float:left">
                                        <p><b><?= $lbl1029 ?>: </b><?= $classdtl[0]['c_name']." - ".$classdtl[0]['c_section']." (".$classdtl[0]['school_sections'].")" ?> </p>
                                    ...
                                    <div class="col-sm-7" style="float:left">
                                        <p><b>Title: </b><?= ucwords($datadetails[0]['title'])  ?> </p>
                                ...
                                <div class="col-md-3 align-right">
                                    ...
                                    <a href="<?= $baseurl ?>teacherexamAssessment?examid=<?= $examid ?>&examAssmodal=1" title="Back" class="btn btn-info" id="examAss_modal" ><?= $lbl41 ?></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-box row container">-->
                            <div class="col-md-12">
                                <div class="form-group">  
                                    <label><?= $lbl1509 ?></label>
                                    <input type="text" name="question" id="question" placeholder="Enter Question"  class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">  
                                    <label><?= $lbl1246 ?></label>
                                    <input type="number" name="marks" id="marks" placeholder="Enter Marks"  class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">  
                           ...
                           <!-- <button class="col-sm-1 btn add-btn"><i class="fa fa-plus"></i></button>-->
                            ...
                            <div class="col-md-12" id="maxwords">
                                <div class="form-group">  
                                    ...
                                    <input type="number" name="maxwords" id="maxwords" placeholder="Enter max words"  class="form-control">
                                </div>
                            </div>
...
<div class="modal classmodal animated zoomIn" id="ecutsomize_exam" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php	echo $this->Form->create(false , ['url' => ['action' => 'edcustmque'] , 'id' => "teditquesform" , 'method' => "post", 'enctype' => "multipart/form-data" ]); ?>
                <div class="row clearfix">
                    <!--<div class="wrapper" style="width:100% !important">
                        <div class="input-box row container">-->
                            <div class="col-md-12">
