...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
				<div class="row">
				    <h2 class="col-lg-6 heading"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1729') { echo $langlbl['title'] ; } } ?> (<?= $sub_name ?> (<?= $cls_name ?>))</h2>
				    <ul class="header-dropdown">
                        ...
                        <li>
                            <a href="<?= $baseurl ?>Studentsubjects?openmodal=1&subjectid=<?= $subjectid ?>&classid=<?= $classid ?>" class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="body">
                <div class="row viewtutcontent" id="viewtutcontent">
                    ...
                    <a href="<?=$baseurl?>ClassLibrary/viewcontent/<?php echo md5($content['id']) ?>" title="view" target="_blank">
                        <!--<ul id="right_icon">
                        ...
                        <?php } else { ?>
                            <img src ="http://www.you-me-globaleducation.org/youme-logo.png" style="padding: 83px 0;border: 1px solid #cccccc;">
                        <?php } ?>
