...
<input type="hidden" name="reportcrd" value="firstclasspremire">
...
<td class="s12" dir="ltr"><input type="number" class="sec1_sub1" name="subject[<?= $first_period->id ?>]" value="<?php if($period_first){ echo $period_first->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec1_sub1_mark2" dir="ltr"><?php if($period_first){ echo $period_first->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s14"></td>
<td class="s12 sec1_sub1_mark4" dir="ltr"><?php if($period_first){ echo $period_first->max_marks * 4; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec1_sub1" name="subject[<?= $first_period->id ?>]" value="<?php if($period_first){ echo $period_first->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14">  </td>
...
<td class="s12 sec1_sub1_mark4" dir="ltr"><?php if($period_first){ echo $period_first->max_marks * 4; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec1_sub1_mark8" dir="ltr"><?php if($period_first){ echo $period_first->max_marks * 12; }else{ echo "240"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec1_sub2" name="subject[<?= $second_period->id ?>]" value="<?php if($period_second){ echo $period_second->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec1_sub2_mark2" dir="ltr"><?php if($period_second){ echo $period_second->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec1_sub2_mark4" dir="ltr"><?php if($period_second){ echo $period_second->max_marks * 4 ; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec1_sub2" name="subject[<?= $second_period->id ?>]" value="<?php if($period_second){ echo $period_second->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec1_sub2_mark4" dir="ltr"><?php if($period_second){ echo $period_second->max_marks * 4 ; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec1_sub2_mark8" dir="ltr"><?php if($period_second){ echo $period_second->max_marks * 12 ; }else{ echo "240"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
    <th id="645166884R11" style="height: 20px;" class="row-headers-background">
     ...
     <?php if($period_first){ $sec1 = $period_first->max_marks; }else{ $sec1 = 20; } 
...
<td class="s12" dir="ltr"><input type="number" class="sec2_sub1" name="subject[<?= $third_period->id ?>]" value="<?php if($period_third){ echo $period_third->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s14"> </td> 
<td class="s14"> </td>
<td class="s12 se42_sub1_mark2" dir="ltr"><?php if($period_third){ echo $period_third->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec2_sub1_mark4" dir="ltr"><?php if($period_third){ echo $period_third->max_marks * 4; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec2_sub1" name="subject[<?= $third_period->id ?>]" value="<?php if($period_third){ echo $period_third->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s14"> </td>
<td class="s14"> </td>
<td class="s12 sec2_sub1_mark2" dir="ltr"><?php if($period_third){ echo $period_third->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec2_sub1_mark4" dir="ltr"><?php if($period_third){ echo $period_third->max_marks * 4; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec2_sub1" name="subject[<?= $third_period->id ?>]" value="<?php if($period_third){ echo $period_third->max_marks ; }else{ echo "10"; } ?>"></td>
...
<td class="s12 sec2_sub1_mark4" dir="ltr"><?php if($period_third){ echo $period_third->max_marks * 4; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec2_sub1_mark8" dir="ltr"><?php if($period_third){ echo $period_third->max_marks * 12; }else{ echo "120"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s11" dir="ltr">Expression Orale</td>
<td class="s12" dir="ltr"><input type="number" class="sec2_sub2" name="subject[<?= $fourth_period->id ?>]" value="<?php if($period_fourth){ echo $period_fourth->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec2_sub2_mark2" dir="ltr"><?php if($period_fourth){ echo $period_fourth->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec2_sub2_mark4" dir="ltr"><?php if($period_fourth){ echo $period_fourth->max_marks * 4; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec2_sub2" name="subject[<?= $fourth_period->id ?>]" value="<?php if($period_fourth){ echo $period_fourth->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec2_sub2_mark4" dir="ltr"><?php if($period_fourth){ echo $period_fourth->max_marks * 4; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec2_sub2_mark8" dir="ltr"><?php if($period_fourth){ echo $period_fourth->max_marks * 12; }else{ echo "240"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
    ...
    <?php if($period_third){ $sec3 = $period_third->max_marks; }else{ $sec3 = 10; }
        if($period_fourth){ $sec4 = $period_fourth->max_marks; }else{ $sec4 = 20; } 
        $max_mrk2 = $sec4 + $sec3;
    ?>
    <td class="s16" dir="ltr">Sous-Total</td>
...
<tr style="height: 20px;    border-bottom: 3px solid;">
...
<td class="s17" dir="ltr"><input type="number" class="sec3_sub1" name="subject[<?= $fifth_period->id ?>]" value="<?php if($period_fifth){ echo $period_fifth->max_marks ; }else{ echo "30"; } ?>"></td>
<td class="s20"> </td>
<td class="s18"> </td>
<td class="s17 sec3_sub1_mark2" dir="ltr"><?php if($period_fifth){ echo $period_fifth->max_marks * 2 ; }else{ echo "60"; } ?></td>
<td class="s18"> </td>
<td class="s17 sec3_sub1_mark4" dir="ltr"><?php if($period_fifth){ echo $period_fifth->max_marks * 4 ; }else{ echo "120"; } ?></td>
<td class="s18"> </td>
<td class="s17" dir="ltr"><input type="number" class="sec3_sub1" name="subject[<?= $fifth_period->id ?>]" value="<?php if($period_fifth){ echo $period_fifth->max_marks ; }else{ echo "30"; } ?>"></td>
<td class="s20"> </td>
<td class="s18"> </td>
...
<td class="s17 sec3_sub1_mark4" dir="ltr"><?php if($period_fifth){ echo $period_fifth->max_marks * 4 ; }else{ echo "120"; } ?></td>
<td class="s18"> </td>
<td class="s17 sec3_sub1_mark8" dir="ltr"><?php if($period_fifth){ echo $period_fifth->max_marks * 12 ; }else{ echo "360"; } ?></td>
<td class="s19"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec3_sub2" name="subject[<?= $sixth_period->id ?>]" value="<?php if($period_sixth){ echo $period_sixth->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"></td>    
<td class="s14"> </td>
<td class="s12 sec3_sub2_mark2" dir="ltr"><?php if($period_sixth){ echo $period_sixth->max_marks * 2 ; }else{ echo "20"; } ?></td>

<td class="s14"> </td>
<td class="s12 sec3_sub2_mark4" dir="ltr"><?php if($period_sixth){ echo $period_sixth->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec3_sub2" name="subject[<?= $sixth_period->id ?>]" value="<?php if($period_sixth){ echo $period_sixth->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec3_sub2_mark4" dir="ltr"><?php if($period_sixth){ echo $period_sixth->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec3_sub2_mark8" dir="ltr"><?php if($period_sixth){ echo $period_sixth->max_marks * 12 ; }else{ echo "120"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec3_sub3" name="subject[<?= $sevent_period->id ?>]" value="<?php if($period_sevent){ echo $period_sevent->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec3_sub3_mark2" dir="ltr"><?php if($period_sevent){ echo $period_sevent->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec3_sub3_mark4" dir="ltr"><?php if($period_sevent){ echo $period_sevent->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec3_sub3" name="subject[<?= $sevent_period->id ?>]" value="<?php if($period_sevent){ echo $period_sevent->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec3_sub3_mark4" dir="ltr"><?php if($period_sevent){ echo $period_sevent->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec3_sub3_mark8" dir="ltr"><?php if($period_sevent){ echo $period_sevent->max_marks * 12 ; }else{ echo "120"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec3_sub4" name="subject[<?= $eight_period->id ?>]" value="<?php if($period_eight){ echo $period_eight->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec3_sub4_mark2" dir="ltr"><?php if($period_eight){ echo $period_eight->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec3_sub4_mark4" dir="ltr"><?php if($period_eight){ echo $period_eight->max_marks * 4 ; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec3_sub4" name="subject[<?= $eight_period->id ?>]" value="<?php if($period_eight){ echo $period_eight->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec3_sub4_mark4" dir="ltr"><?php if($period_eight){ echo $period_eight->max_marks * 4 ; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec3_sub4_mark8" dir="ltr"><?php if($period_eight){ echo $period_eight->max_marks * 12 ; }else{ echo "240"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec3_sub5" name="subject[<?= $nine_period->id ?>]" value="<?php if($period_nine){ echo $period_nine->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec3_sub5_mark2" dir="ltr"><?php if($period_nine){ echo $period_nine->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec3_sub5_mark4" dir="ltr"><?php if($period_nine){ echo $period_nine->max_marks * 4 ; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec3_sub5" name="subject[<?= $nine_period->id ?>]" value="<?php if($period_nine){ echo $period_nine->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec3_sub5_mark4" dir="ltr"><?php if($period_nine){ echo $period_nine->max_marks * 4 ; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec3_sub5_mark8" dir="ltr"><?php if($period_nine){ echo $period_nine->max_marks * 12 ; }else{ echo "240"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec3_sub6" name="subject[<?= $ten_period->id ?>]" value="<?php if($period_ten){ echo $period_ten->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec3_sub6_mark2" dir="ltr"><?php if($period_ten){ echo $period_ten->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec3_sub6_mark4" dir="ltr"><?php if($period_ten){ echo $period_ten->max_marks * 4 ; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec3_sub6" name="subject[<?= $ten_period->id ?>]" value="<?php if($period_ten){ echo $period_ten->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec3_sub6_mark4" dir="ltr"><?php if($period_ten){ echo $period_ten->max_marks * 4 ; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec3_sub6_mark8" dir="ltr"><?php if($period_ten){ echo $period_ten->max_marks * 12 ; }else{ echo "240"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec3_sub7" name="subject[<?= $eleven_period->id ?>]" value="<?php if($period_eleven){ echo $period_eleven->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec3_sub7_mark2" dir="ltr"><?php if($period_eleven){ echo $period_eleven->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec3_sub7_mark4" dir="ltr"><?php if($period_eleven){ echo $period_eleven->max_marks * 4 ; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec3_sub7" name="subject[<?= $eleven_period->id ?>]" value="<?php if($period_eleven){ echo $period_eleven->max_marks ; }else{ echo "20"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec3_sub7_mark4" dir="ltr"><?php if($period_eleven){ echo $period_eleven->max_marks * 4 ; }else{ echo "80"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec3_sub7_mark8" dir="ltr"><?php if($period_eleven){ echo $period_eleven->max_marks * 12 ; }else{ echo "240"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec3_sub8" name="subject[<?= $twelve_period->id ?>]" value="<?php if($period_twelve){ echo $period_twelve->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec3_sub8_mark2" dir="ltr"><?php if($period_twelve){ echo $period_twelve->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec3_sub8_mark4" dir="ltr"><?php if($period_twelve){ echo $period_twelve->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec3_sub8" name="subject[<?= $twelve_period->id ?>]" value="<?php if($period_twelve){ echo $period_twelve->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec3_sub8_mark4" dir="ltr"><?php if($period_twelve){ echo $period_twelve->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec3_sub8_mark8" dir="ltr"><?php if($period_twelve){ echo $period_twelve->max_marks * 12 ; }else{ echo "120"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
    ...
    <?php 
        if($period_fifth){ $sec5 = $period_fifth->max_marks; }else{ $sec5 = 30; } 
        ...
        if($period_ten){ $sec10 = $period_ten->max_marks; }else{ $sec10 = 20; }
        if($period_eleven){ $sec11 = $period_eleven->max_marks; }else{ $sec11 = 20; }
        if($period_twelve){ $sec12 = $period_twelve->max_marks; }else{ $sec12 = 10; }
        $max_mrk3 = $sec5 + $sec6 + $sec7 + $sec8 + $sec9 + $sec10 + $sec11 + $sec12;
    ?>
    <td class="s16" dir="ltr">Sous-Total</td>
...
<td class="s12" dir="ltr"><input type="number" class="sec4_sub1" name="subject[<?= $threteen_period->id ?>]" value="<?php if($period_threteen){ echo $period_threteen->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec4_sub1_mark2" dir="ltr"><?php if($period_threteen){ echo $period_threteen->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec4_sub1_mark4" dir="ltr"><?php if($period_threteen){ echo $period_threteen->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec4_sub1" name="subject[<?= $threteen_period->id ?>]" value="<?php if($period_threteen){ echo $period_threteen->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec4_sub1_mark4" dir="ltr"><?php if($period_threteen){ echo $period_threteen->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec4_sub1_mark8" dir="ltr"><?php if($period_threteen){ echo $period_threteen->max_marks * 12 ; }else{ echo "120"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec4_sub2" name="subject[<?= $nineteen_period->id ?>]" value="<?php if($period_nineteen){ echo $period_nineteen->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec4_sub2_mark2" dir="ltr"><?php if($period_nineteen){ echo $period_nineteen->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec4_sub2_mark4" dir="ltr"><?php if($period_nineteen){ echo $period_nineteen->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec4_sub2" name="subject[<?= $nineteen_period->id ?>]" value="<?php if($period_nineteen){ echo $period_nineteen->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec4_sub2_mark4" dir="ltr"><?php if($period_nineteen){ echo $period_nineteen->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec4_sub2_mark8" dir="ltr"><?php if($period_nineteen){ echo $period_nineteen->max_marks * 12 ; }else{ echo "120"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
    ...
    <?php if($period_threteen){ $sec13 = $period_threteen->max_marks; }else{ $sec13 = 10; } 
        if($period_nineteen){ $sec19 = $period_nineteen->max_marks; }else{ $sec19 = 10; } 
        $max_mrk4 = $sec13 + $sec19;
    ?>
    <td class="s16" dir="ltr">Sous-Total</td>
...
<td class="s12" dir="ltr"><input type="number" class="sec5_sub1" name="subject[<?= $twentytwo_period->id ?>]" value="<?php if($period_twentytwo){ echo $period_twentytwo->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec5_sub1_mark2" dir="ltr"><?php if($period_twentytwo){ echo $period_twentytwo->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec5_sub1_mark4" dir="ltr"><?php if($period_twentytwo){ echo $period_twentytwo->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec5_sub1" name="subject[<?= $twentytwo_period->id ?>]" value="<?php if($period_twentytwo){ echo $period_twentytwo->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec5_sub1_mark4" dir="ltr"><?php if($period_twentytwo){ echo $period_twentytwo->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec5_sub1_mark8" dir="ltr"><?php if($period_twentytwo){ echo $period_twentytwo->max_marks * 12 ; }else{ echo "120"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec5_sub2" name="subject[<?= $twentythree_period->id ?>]" value="<?php if($period_twentythree){ echo $period_twentythree->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec5_sub2_mark2" dir="ltr"><?php if($period_twentythree){ echo $period_twentythree->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec5_sub2_mark4" dir="ltr"><?php if($period_twentythree){ echo $period_twentythree->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec5_sub2" name="subject[<?= $twentythree_period->id ?>]" value="<?php if($period_twentythree){ echo $period_twentythree->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec5_sub2_mark4" dir="ltr"><?php if($period_twentythree){ echo $period_twentythree->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec5_sub2_mark8" dir="ltr"><?php if($period_twentythree){ echo $period_twentythree->max_marks * 12 ; }else{ echo "120"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
    ...
    <?php if($period_twentytwo){ $sec22 = $period_twentytwo->max_marks; }else{ $sec22 = 10; } 
        if($period_twentythree){ $sec23 = $period_twentythree->max_marks; }else{ $sec23 = 10; }
        $max_mrk5 = $sec22 + $sec23;
    ?>
    <td class="s16" dir="ltr">Sous-Total</td>
...
<td class="s12" dir="ltr"><input type="number" class="sec6_sub1" name="subject[<?= $twentyfive_period->id ?>]" value="<?php if($period_twentyfive){ echo $period_twentyfive->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec6_sub1_mark2" dir="ltr"><?php if($period_twentyfive){ echo $period_twentyfive->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec6_sub1_mark4" dir="ltr"><?php if($period_twentyfive){ echo $period_twentyfive->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec6_sub1" name="subject[<?= $twentyfive_period->id ?>]" value="<?php if($period_twentyfive){ echo $period_twentyfive->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec6_sub1_mark4" dir="ltr"><?php if($period_twentyfive){ echo $period_twentyfive->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec6_sub1_mark8" dir="ltr"><?php if($period_twentyfive){ echo $period_twentyfive->max_marks * 12 ; }else{ echo "120"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec6_sub2" name="subject[<?= $twentyfour_period->id ?>]" value="<?php if($period_twentyfour){ echo $period_twentyfour->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec6_sub2_mark2" dir="ltr"><?php if($period_twentyfour){ echo $period_twentyfour->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec6_sub2_mark4" dir="ltr"><?php if($period_twentyfour){ echo $period_twentyfour->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec6_sub2" name="subject[<?= $twentyfour_period->id ?>]" value="<?php if($period_twentyfour){ echo $period_twentyfour->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec6_sub2_mark4" dir="ltr"><?php if($period_twentyfour){ echo $period_twentyfour->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec6_sub2_mark8" dir="ltr"><?php if($period_twentyfour){ echo $period_twentyfour->max_marks * 12 ; }else{ echo "120"; } ?></td>
<td class="s15"> </td>
</tr>
<tr style="height: 20px">
...
<td class="s12" dir="ltr"><input type="number" class="sec6_sub3" name="subject[<?= $twentysix_period->id ?>]" value="<?php if($period_twentysix){ echo $period_twentysix->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
<td class="s12 sec6_sub3_mark2" dir="ltr"><?php if($period_twentysix){ echo $period_twentysix->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"> </td>   
<td class="s12 sec6_sub3_mark4" dir="ltr"><?php if($period_twentysix){ echo $period_twentysix->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12" dir="ltr"><input type="number" class="sec6_sub3" name="subject[<?= $twentysix_period->id ?>]" value="<?php if($period_twentysix){ echo $period_twentysix->max_marks ; }else{ echo "10"; } ?>"></td>
<td class="s13"> </td>
<td class="s14"> </td>
...
<td class="s12 sec6_sub3_mark4" dir="ltr"><?php if($period_twentysix){ echo $period_twentysix->max_marks * 4 ; }else{ echo "40"; } ?></td>
<td class="s14"> </td>
<td class="s12 sec6_sub3_mark8" dir="ltr"><?php if($period_twentysix){ echo $period_twentysix->max_marks * 12 ; }else{ echo "120"; } ?></td>
<td class="s15"> </td>
</tr>
            <tr style="height: 20px">
                ...
                <?php if($period_twentyfive){ $sec25 = $period_twentyfive->max_marks; }else{ $sec25 = 10; }
                    if($period_twentyfour){ $sec24 = $period_twentyfour->max_marks; }else{ $sec24 = 10; }
                    if($period_twentysix){ $sec26 = $period_twentysix->max_marks; }else{ $sec26 = 10; }
                    $max_mrk6 = $sec25 + $sec24 + $sec26;
                ?>
...
<script>
    $(".sec1_sub1").blur(function(){
        ...
        var tot1_sub1_maxi = parseFloat(sec1_sub1) + parseFloat(sec1_sub2);
    ...
    $(".sec1_sub2").blur(function(){
        ...
        var tot1_sub2_maxi = parseFloat(sec1_sub1) + parseFloat(sec1_sub2);
        $(".sec1_final_mark").html('');
        $(".sec1_final_mark2").html('');
        $(".sec1_final_mark4").html('');
        $(".sec1_final_mark8").html('');
    ...
    $(".sec2_sub1").blur(function(){
        ...
        var tot2_sub1_maxi = parseFloat(sec2_sub1) + parseFloat(sec2_sub2);
    ...
    $(".sec2_sub2").blur(function(){
        ...
        var tot2_sub2_maxi = parseFloat(sec2_sub1) + parseFloat(sec2_sub2);
        $(".sec2_final_mark").html('');
        $(".sec2_final_mark2").html('');
        $(".sec2_final_mark4").html('');
        $(".sec2_final_mark8").html('');
    ...
    $(".sec4_sub1").blur(function(){
        ...
        var tot4_sub1_maxi = parseFloat(sec4_sub1) + parseFloat(sec4_sub2);
    ...
    $(".sec4_sub2").blur(function(){
        ...
        var tot4_sub2_maxi = parseFloat(sec4_sub1) + parseFloat(sec4_sub2);
        $(".sec4_final_mark").html('');
        $(".sec4_final_mark2").html('');
        $(".sec4_final_mark4").html('');
        $(".sec4_final_mark8").html('');
