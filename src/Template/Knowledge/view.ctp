    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                ...
                { ?>
                <div class="row">
                    <h2 class="col-lg-11 align-left heading" style="font-size:20px !important; "><?= ucwords($knowledge_details[0]['file_title']) ?></h2>
                    <!--<h2 class="col-lg-2 align-right"><a href="<?=$baseurl?>img/<?php echo $knowledge_details[0]['file_link_name']?>" title="Download PDF" download class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1492') { echo $langlbl['title'] ; } } ?></a></h2>
                    -->
                    <!--<h2 class="col-lg-2 align-right"><a href="javascript:void(0);"  data-file="<?php echo $knowledge_details[0]['file_link_name']?>" title="View PDF" class="btn btn-sm btn-success viewpdffile"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1498') { echo $langlbl['title'] ; } } ?></a></h2>-->
                    
                    <h2 class="col-lg-1 align-right"><a href="<?=$baseurl?>knowledge" title="Back"  class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></h2>
                </div>
                <?php } else {?>    
                <div class="row">
                    <h2 class="col-lg-11 align-left heading" style="font-size:20px !important; "><?= ucwords($knowledge_details[0]['file_title']) ?></h2>
                ...
                <?php } 
                if(!empty($knowledge_details[0]['file_description'])) {?>
            ...
            <div class="body">
                <div class="row clearfix mb-4">
                    ...
                    { ?>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <?php
                                ...
                                <div width="860" height="350"><?= $knowledge_details[0]['file_link_name'] ?> </div>
                            <?php    }
                            ?>
                        </div>
                    <?php
                    ...
                    if($knowledge_details[0]['file_type'] == "audio")
                    {
                        ...
                        <?php
                        if(!empty($knowledge_details[0]['image'] )) { ?>
                        <div class="col-sm-4 text-center">
                             <div id="audio" style="position:absolute; padding-top:150px; text-align: center !important;">
                                <audio controls src="<?=$baseurl?>img/<?php echo $knowledge_details[0]['file_link_name']?>" type="audio/mpeg" style="margin-left:20px !important;">
                                    Your browser does not support the
                                    <code>audio</code> element.
                                </audio>
                            </div>
                            <img src="<?= $baseurl ?>/webroot/img/<?= $knowledge_details[0]['image']?>" style="min-width:350px; min-height:400px; max-width:350px; max-height:400px;border: 1px solid; text-align: center !important;">
                        ...
                        <?php } else { ?>
                            <div class="col-sm-4 text-center" style="padding-top:150px; background: url(https://you-me-globaleducation.org/youme-logo.png)no-repeat center; max-width: 350px; height: 400px; border: 1px solid; text-align: center !important;">
                    ...
                    { $valpag = $knowledge_details[0]['numpages'];
                        ...
                        <div class="col-sm-12 text-center" style="margin: auto;height: 500px;overflow: scroll;">
                            ...
                            for ($x = 0; $x < $valpag; $x++) {
                            ?>    
                            <img src="http://you-me-globaleducation.org/school/<?=$knowledge_details[0]['dirname'];?>/<?= $knowledge_details[0]['file_link_name']; ?><?=$x;?>.jpg" style="width: 100%;">
                            <?php  } ?>
                          
                        <!--<iframe src='http://docs.google.com/gview?embedded=true&url=https://you-me-globaleducation.org/school/img/<?php echo $knowledge_details[0]['file_link_name']?>' height='600px' width="100%" style="left:0px !important; position:inherit !important;"></iframe>-->
                        </div>
                        <?php
                    }
                    ?>
                				...
                				<?php if (count($comments_details) != 0): ?>
                    				...
                    				<div class="comment clearfix">
                    					...
                    					<div class="comment-details">
                    						...
                    						<a class="reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1488') { echo $langlbl['title'] ; } } ?></a>
                    					</div>
                    					<div class="col-sm-12 clearfix">
                    						...
                    						<?php if (isset($replies_details)): ?>
                    							...
                    							?>
                    								...
                    								<div class="comment reply clearfix">
                    									<!--<img src="profile.png" alt="" class="profile_pic">-->
                    									<div class="comment-details">
                    										<span class="comment-name"><?php echo $reply["user_name"] ?></b> - </span>
