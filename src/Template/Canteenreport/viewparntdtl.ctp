        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <div class=" row">
                            <h2 class="col-md-11 heading">View detailing report </h2>
                            <ul class="header-dropdown">
                                <li><a href="<?= $baseurl ?>canteenreport/parentreport" title="Back" class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></li>
                            </ul>
                        </div>
                        <div class=" row col-md-12 mt-4">
                            Student: <?= $student_details['l_name']." ".$student_details['f_name']; ?> <br>
