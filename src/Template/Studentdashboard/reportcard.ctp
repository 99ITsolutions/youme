    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            ...
            <div class="header row">
                ...
                <h2 class="col-md-6 align-right"><a href="<?= $baseurl ?>studentdashboard" title="Back" class=" btn btn-primary" ><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1162') { echo $langlbl['title'] ; } } ?> </a></h2>
...
<?php echo $this->Form->create(false , ['url' => ['action' => 'subreport'] , 'id' => "subreportform" , 'class' => "form" , 'method' => "post"  ]); ?>
...
<div class="pol-md-12">
  ...
  <table id="example" cellpadding="0" cellspacing="0" class="display nowrap no-footer head-bot" style="width: 100%;" role="grid" aria-describedby="example_info">
                     ...
                     <?php if($report_marks['nid'] == ""){?>  
                        ...
                        <td><input type="text" name="nid[]" maxlength="1" required="required" readonly="readonly"></td>
                 ...
                 <?php }else{ ?>
                        ...
                        <td><input type="text" name="nid[]" value="<?=$val;?>" maxlength="1" readonly="readonly" required="required" style="font-weight: bold;"></td>
...
<tr class="prov-td">
  ...
  <td style="border-right: 2px solid #333 !important;"><input type="text" readonly="readonly" name="province" value="<?=$report_marks['province'];?>" required="required" class="" style="width: 100%; font-weight:bold;"></td>
...
<table id="example" class="display nowrap dataTable no-footer head-bot" style="width: 100%; margin-top: 6px;" role="grid" aria-describedby="example_info">
                    ...
                    <?php if($report_marks['code'] == ""){?>     
                        ...
                        <td><input type="text" name="code[]" maxlength="1" required="required" readonly="readonly"></td>
                      ...
                      <?php }else{ ?>
                        ...
                        <td><input type="text" name="code[]" readonly="readonly" maxlength="1" value="<?=$val;?>" required="required" style="font-weight: bold;"></td>
...
<input type="text" name="neea" readonly="readonly" value="<?=$report_marks['neea'];?>" style="font-weight: bold;"  required="required">
...
<input type="text" name="lethe[]" maxlength="2" value="<?=$exlethe[2];?>" style="font-weight: bold;" required="required" readonly="readonly">
...
<table id="example" class="display nowrap dataTable no-footer head-bot" style="width: 100%;    margin-top: 6px;" role="grid" aria-describedby="example_info">
                        ...
                        <td><input type="text" name="nperm[]" maxlength="1" required="required" readonly="readonly"></td>
                        ...
                        <td><input type="text" name="nperm[]" value="<?=$val;?>" readonly="readonly" maxlength="1" required="required" style="font-weight: bold;"></td>
...
<div class="col-md-12 p-0">
  ...
  <h5>Bullentin LA 8<sub>times</sub> Annee cycle terminal DE Base (CTEB) Anne Scolaire 20
    ...
    <input type="text" name="" style="border-bottom: 1px dashed #333;" readonly="readonly">
...
<div class="pol-md-2" style="background: #071a2a;margin-top: -1px;height: 46px;">
 ...
 $marks = array(20,20,20,20,70,20,10,20,10,10,10,10,10,10,10,30,20,20,20,20,20);
...
<div class="pol-md-2 border-left-sub">
  ...
  <input type="number" name="max2[]" class="max2 mymarks1<?=$i;?>" id="<?=$i;?>" readonly="readonly" value="<?=$arrmax2[$d];?>" min="0" style="width: 60px;text-align: center;">
 ...
 <div class="pol-md-2 border-left-sub">
   ...
   <input type="number" name="max3[]" class="max3 mymarks2<?=$i;?>" id="<?=$i;?>" readonly="readonly" value="<?=$arrmax3[$d];?>" min="0" style="width: 60px;text-align: center;">
...
<div class="pol-md-3 border-left-sub">
 ...
 <input type="number" name="max21[]" class="max21" id="highmarks2<?=$i;?>" readonly="readonly" value="<?=$marks[$i]*2;?>" readonly min="0">
 ...
 <input type="number" name="max22[]" class="max22 mymarks3<?=$i;?>" id="<?=$i;?>" readonly="readonly" value="<?=$arrmax22[$d];?>" min="0" style="width: 45px;text-align: center;">

    <?php }else{ ?>

  <input type="number" name="max22[]" class="max22 mymarks3<?=$i;?>" id="<?=$i;?>" readonly="readonly" value="<?=$arrmax22[$d];?>" readonly min="0" style="width: 45px;text-align: center;">    
 ...
 <input type="number" name="maxtot[]" class="maxtot  mymaxtot<?=$i;?>" readonly="readonly" value="" min="0" readonly="">

 </div>

 <div class="pol-md-6 border-left-sub">

   <input type="number" name="maxgettot[]" class="maxgettot mymaxget<?=$i;?>" readonly="readonly" value="" min="0" readonly="" style="width: 44px; text-align: center;">
...
<div class="pol-md-2 border-left-sub">
  ...
  <input type="number" name="nmax2[]" class="nmax2 nmymarks1<?=$i;?>" id="<?=$i;?>" readonly="readonly" value="<?=$arrnmax2[$d];?>" min="0" style="width: 60px; text-align: center;">
 ...
 <div class="pol-md-2 border-left-sub">
  ...
  <input type="number" name="nmax3[]" class="nmax3 nmymarks2<?=$i;?>" id="<?=$i;?>" readonly="readonly" value="<?=$arrnmax3[$d];?>" min="0" style="width: 60px;text-align: center;">
...
<?php if($arrnmax22[$d] == "0"){?>    
 ...
 <input type="number" name="nmax22[]" class="nmax22 nmymarks3<?=$i;?>" id="<?=$i;?>" readonly="readonly" value="0" min="0" style="width: 45px; text-align: center;">
...
<input type="number" name="nmaxtot[]" class="nmaxtot mynmaxtot<?=$i;?>" value="" min="0" readonly="readonly">

 </div>

 <div class="pol-md-6 border-left-sub">

   <input type="number" name="nmaxgettot[]" class="nmaxgettot mynmaxget<?=$i;?>" value="" min="0" readonly="" style="width: 45px; text-align: center;">
 ...
 <div class="pol-md-2" style="background: #071a2a;    margin-top: -1px;">
  ...
  <div class="pol-md-4 border-inner-subect">
    ...
    <input type="text" name="percent" class="allpercent" value="" style="width: 100%;text-align: center;" readonly="readonly">
...
<?php if($arrsignprof[$d] == "0"){?>    
    ...
    <input type="text" name="signprof[]" style="width: 100%;" value="" readonly="readonly">

<?php }else{ ?>

    <input type="text" name="signprof[]" style="width: 100%;" value="<?=$arrsignprof[$d];?>" readonly="readonly">
...
<div class="pol-md-2 border-left-sub">
  ...
  <input type="text" name="" class="font-weight" readonly="readonly">
...
<div class="pol-md-2 border-left-sub">
  ...
  <input type="text" name="trisemper1" class="font-weight" id="trisemper1" readonly="readonly" class="trisemper1" style="width: 100%;text-align: center;">

 </div>

 <div class="pol-md-2 border-left-sub">

  <input type="text" name="trisemper2" class="font-weight" id="trisemper2" readonly="readonly" class="trisemper2" style="width: 100%;text-align: center;">
...
<div class="pol-md-3 border-left-sub">
 ...
 <div class="pol-md-6 border-left-sub">
  ...
  <input type="text" name="trisemper3" class="font-weight" id="trisemper3" readonly="readonly" class="trisemper3" style="width: 100%;text-align: center;">
 ...
 <div class="pol-md-6 border-left-sub">
   ...
   <input type="text" name="trisemper4" class="font-weight" id="trisemper4" readonly="readonly" class="trisemper4" style="width: 100%;text-align: center;">
...
<div class="pol-md-2 border-left-sub">
  ...
  <input type="text" name="trisemper5" class="font-weight" readonly="readonly" id="trisemper5" class="trisemper5" style="width: 100%;text-align: center;">

 </div>

 <div class="pol-md-2 border-left-sub">

  <input type="text" name="trisemper6" class="font-weight" readonly="readonly" id="trisemper6" class="trisemper6" style="width: 100%;text-align: center;">
...
<div class="pol-md-3 border-left-sub">
 ...
 <input type="text" name="trisemper7" class="font-weight" id="trisemper7" readonly="readonly" class="trisemper7" style="width: 100%;text-align: center;">
 ...
 <div class="pol-md-6 border-left-sub">
   ...
   <input type="text" name="trisemper8" class="font-weight" id="trisemper8" readonly="readonly" class="trisemper8" style="width: 100%;text-align: center;">
...
<div class="pol-md-2 border-left-sub">
 ...
 <div class="pol-md-2 border-left-sub" readonly="readonly">
...
<div class="pol-md-6 border-left-sub">
  ...
  <div class="pol border-inner-subect2" readonly="readonly">
...
<div class="col-md-12">
  ...
  <div class="smal-sec1">
    ...
    <ul>
      ...
      <li><p>Lélève ne pourra passer dans la classe superieure s'il n'a subi avec succès un examen de repêchage en<br>

  <?php 

  if($report_marks['bull'] == ""){?>       

    <input type="text" name="bull[]" style="border-bottom: 1px dashed #333;" readonly="readonly"> 
  ...
  <?php }else{ ?>
      ...
      <input type="text" name="bull[]" value="<?=$val;?>" style="border-bottom: 1px dashed #333; font-weight: bold;" readonly="readonly">
...
<?php $faltdat = explode(",", $report_marks['faltdat']); ?>
    ...
    <p style="text-transform: full-size-kana;">Falt à <input type="text" readonly="" name="falt" value="<?=$report_marks['falt'];?>" style="border-bottom: 1px dashed #333;width: 230px; font-weight: bold;">

    le 

  <?php  if($faltdat[0] == ""){ ?> 

    <input type="text" name="faltdat[]" value="" style="border-bottom: 1px dashed #333;width: 60px;" readonly="readonly">

  <?php }else{?>

    <input type="text" name="faltdat[]" value="<?=$faltdat[0];?>" readonly="readonly" style="border-bottom: 1px dashed #333;width: 60px; font-weight: bold;">
  ...
  <?php }else{?>
    ...
    <input type="text" name="faltdat[]" readonly="readonly" value="<?=$faltdat[1];?>" style="border-bottom: 1px dashed #333;width: 60px; font-weight: bold;">
  ...
  <?php }else{?>
    ...
    <input type="text" name="faltdat[]" value="<?=$faltdat[2];?>" style="border-bottom: 1px dashed #333;width: 60px; font-weight: bold;" readonly="readonly">
...
$(document).ready(function(){
  ...
  <?php if($report_marks['max22'] != ""){ ?>
   ...
   <?php } ?>
        ...
        $('.allpercent').each(function(){

              var higher1 = $(".mymaxtot"+p).val();

              var higher2 = $(".mynmaxtot"+p).val();

              var getmarks1 = $(".mymaxget"+p).val();

              var getmarks2 = $(".mynmaxget"+p).val();

              var totalmarks = Number(higher1) + Number(higher2);

              var getmarks = Number(getmarks1) + Number(getmarks2);

              var percent = getmarks/totalmarks*100

              var nab = percent.toFixed(2)+"%";
