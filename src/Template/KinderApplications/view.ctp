    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                ...
                <div class="row clearfix container mt-2 mb-4">1. Please ensure to view the file in your browser this extension is in your device. <a href="https://chrome.google.com/webstore/detail/docs-online-viewer/gmpljdlgcdkljlppaekciacdmdlhfeon?hl=en" target="_blank"> Click Here to download </a></div>
                <?php
                ...
                <div class="row">
                    ...
                    <ul class="header-dropdown">
                        <!--<li><a href="<?=$baseurl?>applications_data/<?php echo $knowledge_details[0]['links']?>" title="Download Data" download class="btn btn-sm btn-success">Download</a></li>
                        ...
                        <?php } else { ?>
                        <li><a href="<?=$baseurl?>applications_data/<?php echo $knowledge_details[0]['links']?>" title="View Data" target="_blank" class="btn btn-sm btn-success">View</a></li>
                        
                        <?php } ?>-->
                        <li><a href="<?=$baseurl?>KinderApplications" title="Back"  class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></li>
                    </ul>
                    ...
                    <h2 class="col-lg-1 align-right"><a href="<?=$baseurl?>KinderApplications" title="Back"  class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></h2>-->
               </div>
                <?php 
            ...
            <div class="body">
                <div class="row clearfix mb-4">
                    ...
                    <?php } else { ?>
                    <div class="col-sm-12 text-center">
                        <img src="https://www.you-me-globaleducation.org/youme-logo.png" style="padding: 135px 0;border: 1px solid #cccccc;" width="350px" height="400px">
                    </div>
                    <?php } ?>-->
                				...
                				<?php if (count($comments_details) != 0): ?>
                    				...
                    				<div class="comment clearfix">
                    					...
                    					<div class="comment-details">
                    						...
                    						<a class="studappcomm_reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1488') { echo $langlbl['title'] ; } } ?></a>
                    					</div>
                    					<div class="col-sm-12 clearfix">
                    					...
                    					<!-- reply form -->
                    					<form class="reply_form clearfix" id="studappcomment_reply_form_<?php echo $comment['id'] ?>" data-id="<?php echo $comment['id']; ?>">
