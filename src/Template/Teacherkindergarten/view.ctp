...
<div class="row clearfix">
        ...
        <div class="card">
            <div class="header">
                ...
                <div class="row">
                    ...
                    <h2 class="col-lg-2 align-right" style="flex: 0 0 11%;   max-width: 11%;"><a href="<?=$baseurl?>img/<?php echo $knowledge_details[0]['links']?>" title="View PDF" target="_blank" class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1498') { echo $langlbl['title'] ; } } ?></a></h2>
                    -->
                    ...
                    <h2 class="col-lg-1 align-right"><a href="<?=$baseurl?>Teacherkindergarten/activity/<?= $knowledge_details[0]['kinderdash_id'] ?>" title="Back" class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></h2>
                    ...
                    if($knowledge_details[0]['file_type'] == "audio")
                    {
                        ...
                        <div class="col-sm-4 text-center">
                             <div id="audio" style="position:absolute; padding-top:150px; text-align: center !important;">
                                <audio controls>
                                    <source src="<?=$baseurl?>img/<?php echo $knowledge_details[0]['links']?>" type="audio/mpeg" style="margin-left:20px !important;">
                                    Your browser does not support the audio tag.
                                </audio>
                                <!--<audio controls src="<?=$baseurl?>img/<?php echo $knowledge_details[0]['links']?>" type="audio/mpeg" style="margin-left:20px !important;">
                        ...
                        <?php } else { ?>
                            <div class="col-sm-4 text-center" style="padding-top:150px; background: url(http://you-me-globaleducation.org/youme-logo.png)no-repeat center; max-width: 350px; height: 400px; border: 1px solid; text-align: center !important;">
                				...
                				<?php if (count($comments_details) != 0): ?>
                    				...
                    				<div class="comment clearfix">
                    					...
                    					<div class="comment-details">
                    						...
                    						<a class="discovertchrcomm_reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1488') { echo $langlbl['title'] ; } } ?></a>
                    					</div>
                    					<div class="col-sm-12 clearfix">
                    					...
                    					<!-- reply form -->
                    					<form class="reply_form clearfix" id="discovertchrcomment_reply_form_<?php echo $comment['id'] ?>" data-id="<?php echo $comment['id']; ?>">
    ...
    $database = "youmeglo_globalweb";
                    					...
                    					$replies = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `kindergarten_library_comments` WHERE parent = '".$comment['id']."'")) ?>
