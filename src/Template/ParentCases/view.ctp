...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <h1 style="font-size:24px"><?php if(count($all_messages) > 1){ ?><b>Re: </b><?php } else { ?> <b>Topic: </b> <?php } ?><?= $get_messages->subject ?></h1>
    ...
    $(this).ajaxSubmit({
        ...
        success: function(response){
            ...
            if(response.result === "success" ){ 
                setTimeout(function(){ location.href = baseurl +"/ParentCases/view/<?= base64_encode($id) ?>" ;  }, 1000);
