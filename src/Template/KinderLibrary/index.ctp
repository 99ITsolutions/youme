	    ...
	    <div class="col-lg-12">
	        <div class="card">
	            <div class="body row  text center">
                    <h2 class="col-md-12" style="font-size: 1.2rem; color:#1B0951 !important; float:left;">Note: Please contact School authority to have access of School Library</h2>
                </div>
	        </div>
	    </div>
    </div>
	                    ...
	                    { 
    	                    ...
    	                    <div class="col-lg-3 col-md-6 col-sm-6 schedulemeeting">
                                <div class="card text-center bg-dash ">
                                    <a  class="colorBtn" href="<?=$baseurl?>kinderLibrary/library/<?= $gradeids ?>/<?= $subjectids[$key] ?>" class="meetinglist" >
