...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2 class="heading"> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '979') { echo $langlbl['title'] ; } } ?></h2>
            ...
            <div class=" container row clearfix">
                <div class="col-md-3">
                    <div class="form-group">
                        <label><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '983') { echo $langlbl['title'] ; } } ?></label>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '984') { echo $langlbl['title'] ; } } ?></label>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '985') { echo $langlbl['title'] ; } } ?></label>
                ...
                <div class="table-responsive">
                    <table class="table table-hover js-basic-example dataTable table-custom table-striped m-b-0 c_list default_pageitem sclproduct_table" id="sclproduct_table" data-page-length='50'>
                        <thead class="thead-dark">
                            <tr>
                                <th> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '859') { echo $langlbl['title'] ; } } ?></th>
                                <th> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '992') { echo $langlbl['title'] ; } } ?></th>
                                <th> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '993') { echo $langlbl['title'] ; } } ?></th>
                                <th> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '994') { echo $langlbl['title'] ; } } ?></th>
                                <th> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '995') { echo $langlbl['title'] ; } } ?></th>
                                <th> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '996') { echo $langlbl['title'] ; } } ?></th>
                                <th> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '988') { echo $langlbl['title'] ; } } ?></th>
                            </tr>
                        </thead>
                        ...
                        <?php foreach($products as $pro) {
                            ...
                            <tr>
                                <td><span>
                                    <!--<img src="<?= $baseurl ?>productimages/<?= $pro['product_image'] ?>" width="70px" height="70px">-->
