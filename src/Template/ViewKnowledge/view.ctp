...
foreach($lang_label as $langlbl) { 
    ...
    if($langlbl['id'] == '1492') { $labl1492 = $langlbl['title'] ; } 
    if($langlbl['id'] == '1498') { $labl1498 = $langlbl['title'] ; } 
    if($langlbl['id'] == '1489') { $labl1489 = $langlbl['title'] ; }
    if($langlbl['id'] == '1490') { $labl1490 = $langlbl['title'] ; }
    if($langlbl['id'] == '1491') { $labl1491 = $langlbl['title'] ; }
    if($langlbl['id'] == '1487') { $labl1487 = $langlbl['title'] ; }
    if($langlbl['id'] == '1488') { $labl1488 = $langlbl['title'] ; } 
    if($langlbl['id'] == '1494') { $labl1494 = $langlbl['title'] ; } 
}
?>
        ...
        <div class="card">
            <div class="header">
                ...
                <div class="row">
                    ...
                    <!--<h2 class="col-lg-2 align-right"><a href="<?=$baseurl?>img/<?php echo $knowledge_details[0]['file_link_name']?>" title="Download PDF" download class="btn btn-sm btn-success"><?= $labl1492  ?></a></h2>-->
                    <!--<h2 class="col-lg-2 align-right"><a href="javascript:void(0);"  data-file="<?php echo $knowledge_details[0]['file_link_name']?>" title="View PDF" class="btn btn-sm btn-success viewpdffile"><?= $labl1498 ?></a></h2>-->
                    
                    
                    <h2 class="col-lg-1 align-right"><a href="<?=$baseurl?>viewKnowledge" title="Back"  class="btn btn-sm btn-success"><?= $labl41 ?></a></h2>
                </div>
                <?php } else {?>    
                <div class="row">
                    <h2 class="col-lg-11 align-left heading" style="font-size:20px !important; "><?= ucwords($knowledge_details[0]['file_title']) ?></h2>
                ...
                <div class="row clearfix mb-4">
                    ...
                    { 
                        ...
                        <div class="col-sm-12 text-center" style="margin: auto;height: 500px;overflow: scroll;">
                            ...
                            <?php  } ?>
                            <!--<iframe src='http://docs.google.com/gview?embedded=true&url=https://you-me-globaleducation.org/school/img/<?php echo $knowledge_details[0]['file_link_name']?>' height='600px' width="100%"></iframe>-->
                        </div>
                        <?php
                    }
                    ?>
                    <div class="col-sm-12 mt-3">
                        <h2 class="heading"><?= $labl1490 ?></h2>
                        <div class="col-sm-12 col-sm-offset-1 comments-section">
                			...
                			<?php echo $this->Form->create(false , ['url' => ['action' => 'addcomment'] , 'id' => "comment_form" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                				...
                				<div class="col-sm-3"  style="float:left">
                				    <button class="btn btn-primary btn-sm submit_comment" id="submit_comment"><?= $labl1491 ?></button>
                				</div>
                			<?php echo $this->Form->end(); ?>
                            <div class="clearfix"></div>
                            
                			<!-- Display total number of comments on this post  -->
                			<h2 class="heading mt-4"><span id="comments_count"><?= count($comments_details) ?></span> <?= $labl1487 ?>(s)</h2>
                			<hr>
                			<!-- comments wrapper -->
                				...
                				<?php if (count($comments_details) != 0): ?>
                    				...
                    				<div class="comment clearfix">
                    					...
                    					<div class="comment-details">
                    						...
                    						<a class="user_reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?= $labl1488 ?></a>
                    					</div>
                    					<div class="col-sm-12 clearfix">
                    					...
                    					<!--	<input type="text" class="form-control" name="reply_text" id="reply_text" >-->
                    						...
                    						<button type="submit" class="btn btn-primary btn-xs pull-right submit-reply"><?= $labl1494 ?></button>
                    					</form>
