    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                    ...
                    <div class="row">
                        <h2 class="heading col-md-6 align-left" ><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1120') { echo $langlbl['title'] ; } } ?></h2>
                    ...
                    <table class="table table-hover js-basic-example dataTable table-custom table-striped m-b-0 c_list default_pageitem notification_table" id="notification_table" data-page-length='50'>
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1126') { echo $langlbl['title'] ; } } ?></th>
                        ...
                        <tbody id="notificationbody" class="modalrecdel">
                            ...
                            { 
                                ...
                                elseif($value['notify_to'] == "all" && $value['added_by'] == "school" && $value['school_id'] == $sclid )
                                { 
                                    $display = 1;
                                }
                                else
                                ...
                                <tr>
                                    ...
                                    <td <?= $bold ?> ><?= date("M d, Y H:i" , strtotime($value['schedule_date'])); ?></td>
                                    <td <?= $bold ?> ><?= ucfirst($value['added_by']); ?></td>
                                    <td <?= $bold ?> ><?= ucfirst($noti_to); ?></td>
                                    <!--<td <?= $bold ?> ><?= ucfirst($nsts); ?></td>-->
                                    <!--<td>
                                    <?php    
                                        if( $value['status'] == 0)
                                        {
