                    ...
                    <div class="body" id="knowledgecenter">
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <a href="<?= $baseurl ?>knowledgeCenter/scl_howitworks">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <a  href="<?= $baseurl ?>knowledgeCenter/tchr_howitworks">
                                <div class="card text-center bg-dash">
                                    <div class="body">
                                        <div class="p-15 text-light">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <a href="<?= $baseurl ?>knowledgeCenter/stud_howitworks">
                                <div class="card text-center bg-dash">
                                    <div class="body">
                                        <div class="p-15 text-light">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <a href="<?= $baseurl ?>knowledgeCenter/parent_howitworks">
                                <div class="card text-center bg-dash">
                                    <div class="body">
                                        <div class="p-15 text-light">
