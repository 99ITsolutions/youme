...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <?php 
                if($knowledge_details[0]['added_for'] == "school")
                {
                    $backbutn = 'scl_howitworks';
                }
                elseif($knowledge_details[0]['added_for'] == "student")
                {
                    $backbutn = 'stud_howitworks';
                }
                elseif($knowledge_details[0]['added_for'] == "teacher")
                {
                    $backbutn = 'tchr_howitworks';
                }
                else
                {
                    $backbutn = 'parent_howitworks';
                }
            ...
            <div class="body">
                <div class="row clearfix mb-4">
                    ...
                    if($knowledge_details[0]['file_type'] == "pdf")
                    {
                        ...
                        <!--<iframe src='https://you-me-globaleducation.org/school/img/<?php echo $knowledge_details[0]['links']?>' height='600px' width="100%"></iframe>-->
                        </div>
                        <?php
                    }
                    ?>
                    <div class="col-sm-12 mt-3">
                        ...
                        <div class="col-sm-12 col-sm-offset-1 comments-section">
                			...
                			<?php echo $this->Form->create(false , ['url' => ['action' => 'addhowworkscomment'] , 'id' => "comment_form" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                				...
                				<?php if (count($comments_details) != 0): ?>
                    				...
                    				<div class="comment clearfix">
                    					...
                    					<div class="comment-details">
                    						...
                    						<a class="hiwcomm_reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1488') { echo $langlbl['title'] ; } } ?></a>
                    					</div>
                    					<div class="col-sm-12 clearfix">
                    					...
                    					<!-- reply form -->
                    					<form class="reply_form clearfix" id="howworkscomment_reply_form_<?php echo $comment['id'] ?>" data-id="<?php echo $comment['id']; ?>">
