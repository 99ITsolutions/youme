				...
				<div class="row">
				    ...
				    <ul class="header-dropdown">
                        ...
                        <li style="width:160px; padding:0px 10px">
                            <select class=" form-control community_filter" id="comm_filter" onchange="intensive_filter(this.value)">
                        ...
                        <li><a href="javascript:void(0)" data-toggle="modal" data-target="#addintensive" title="Add" class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '758') { echo $langlbl['title'] ; } } ?></a></li>
                        <li><a href="<?= $baseurl ?>knowledgeCenter/intensive_english" class="btn btn-info" ><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '759') { echo $langlbl['title'] ; } } ?></a></li>
                    </ul>
                </div>
                <div class="row mt-4">
                    <div class="col-md-3 ">
                        <select class="form-control js-states chosetitle" id="title_filter" onchange="title_filter(this.value, 'intensive')">
            ...
            <div class="body">
                <div class="row col-sm-12" id="viewcommunity">
                        ...
                        <div class="col-sm-2 col_img">
                                <ul id="right_icon">
                                    <li> <a href="javascript:void(0)" data-id="<?php echo $content['id']?>" data-toggle="modal" data-target="#editintensive" class="editintensive" id="editknow" ><i class="fa fa-edit"></i></a></li>
                                    <li> <a href="javascript:void(0)" data-id="<?php echo $content['id']?>" data-url="deleteintensive" class=" js-sweetalert " title="Delete" data-str="Intensive English" data-type="confirm"><i class="fa fa-trash"></i></a></li>
                                    <li> <a href="<?=$baseurl?>knowledgeCenter/viewintensiveenglish/<?php echo md5($content['id']) ?>" class="viewknow" ><i class="fa fa-eye"></i></a></li>
                                </ul>
...
<div class="modal classmodal animated zoomIn" id="addintensive" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header header">
                  <h6 class="title" id="defaultModalLabel"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1473') { echo $langlbl['title'] ; } } ?> </h6>
		  <button type="button" class=" close" data-dismiss="modal">
            ...
            <div class="modal-body">
                           <?php   
                echo $this->Form->create(false , ['url' => ['action' => 'addintensive'] , 'id' => "addcommunityform" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                <div class="row clearfix">
...
<div class="modal classmodal animated zoomIn" id="editintensive" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header header">
                  <h6 class="title" id="defaultModalLabel"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1474') { echo $langlbl['title'] ; } } ?> </h6>
		  <button type="button" class=" close" data-dismiss="modal">
  		   <span aria-hidden="true">&times;</span>
		  </button>
	    </div>
            <div class="modal-body">
                           <?php   
                echo $this->Form->create(false , ['url' => ['action' => 'editintensive'] , 'id' => "editstateexamform" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                <div class="row clearfix">
