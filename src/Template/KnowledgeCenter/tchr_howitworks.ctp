...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
				<div class="row">
				    <input type="hidden" name="addedfor" id="addedfor" value="<?= $addedfor ?>" >
				    <input type="hidden" name="addedfor" id="added_for" value="<?= $addedfor ?>" >
				    <input type="hidden" id="clsfilter" value="" >
				    <h2 class="col-lg-6 heading"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1449') { echo $langlbl['title'] ; } } ?> -> <?= ucfirst($addedfor) ?></h2>
				    <ul class="header-dropdown">
                        
                        <li style="width:160px; padding:0px 10px">
                            <select class=" form-control community_filter" id="comm_filter" onchange="howitworks_filter(this.value)">
                        ...
                        <li><a href="javascript:void(0)" data-toggle="modal" data-target="#addhowitworks" title="Add" class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '758') { echo $langlbl['title'] ; } } ?></a></li>
                        <li><a href="<?= $baseurl ?>knowledgeCenter/howitworks" class="btn btn-info" ><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '759') { echo $langlbl['title'] ; } } ?></a></li>
                    </ul>
                </div>
                <div class="row mt-4">
                    <div class="col-md-3 ">
                        <select class="form-control js-states chosetitle" id="title_filter" onchange="title_filter(this.value, 'howitworks')">
                ...
                <div class="row col-sm-12" id="viewcommunity">
                        ...
                        ?>
                            <div class="col-sm-2 col_img">
                                <ul id="right_icon">
                                    <li> <a href="javascript:void(0)" data-id="<?php echo $content['id']?>" data-toggle="modal" data-target="#edithowitworks" class="edithowitworks" id="editknow" ><i class="fa fa-edit"></i></a></li>
                                    <li> <a href="javascript:void(0)" data-id="<?php echo $content['id']?>" data-url="deletehowitworks" class=" js-sweetalert " title="Delete" data-str="How It Works" data-type="confirm"><i class="fa fa-trash"></i></a></li>
                                    <li> <a href="<?=$baseurl?>knowledgeCenter/viewhowitworks/<?php echo md5($content['id']) ?>" target="_blank" class="viewknow" ><i class="fa fa-eye"></i></a></li>
                                </ul>
...
<div class="modal classmodal animated zoomIn" id="addhowitworks" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header header">
                  <h6 class="title" id="defaultModalLabel"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1467') { echo $langlbl['title'] ; } } ?></h6>
		  <button type="button" class=" close" data-dismiss="modal">
            ...
            <div class="modal-body">
                           <?php   
                echo $this->Form->create(false , ['url' => ['action' => 'addhowitworks'] , 'id' => "addcommunityform" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                <div class="row clearfix">
                    ...
                    <div class="col-sm-4" id="typevideo">
                        ...
                        <div class="form-group">
                            <select class="form-control" name="videotypes" id="videotypes" onchange="video_type(this.value)">
                                ...
                                <option value="d.tube">D.Tube</option>
                            </select>
                        </div>
                    </div>    
                    <input type="hidden" name="data_addedfor" id="data_addedfor" value="<?= $addedfor ?>" >            
                    <div class="col-sm-4">
...
<div class="modal classmodal animated zoomIn" id="edithowitworks" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header header">
                  <h6 class="title" id="defaultModalLabel"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1469') { echo $langlbl['title'] ; } } ?></h6>
		  <button type="button" class=" close" data-dismiss="modal">
  		   <span aria-hidden="true">&times;</span>
		  </button>
	    </div>
            <div class="modal-body">
                           <?php   
                echo $this->Form->create(false , ['url' => ['action' => 'edithowitworks'] , 'id' => "editstateexamform" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                <div class="row clearfix">
                    ...
                    <input type="hidden" name="edata_addedfor" id="edata_addedfor" value="<?= $addedfor ?>" >
                    <div class="col-sm-4">
                        <label><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '765') { echo $langlbl['title'] ; } } ?>*</label>
                        <div class="form-group">
