    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
				<div class="row">
				    ...
				    <ul class="header-dropdown">
                        <li style="width:160px; padding:0px 10px">
                            <select class=" form-control class_s" id="clsfilter" onchange="kccls_filter(this.value)">
                        ...
                        <li style="width:160px; padding:0px 10px">
                            <select class=" form-control community_filter" id="comm_filter" onchange="community_filter(this.value)">
                        ...
                        <li><a href="javascript:void(0)"  data-contnt ="Knowledge Center!" data-str= "Content" data-url = "knowledgeCenter/commdeleteall"  id="checkid" title="Delete All" class="btn btn-sm btn-success">Delete All</a></li>
                        <li><a href="<?= $baseurl ?>knowledgeCenter/community" class="btn btn-info" ><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '759') { echo $langlbl['title'] ; } } ?></a></li>
                    </ul>
                ...
                <div class="row mt-4">
                    <div class="col-md-3 ">
                        <select class="form-control js-states chosetitle" id="title_filter" onchange="title_filter(this.value, 'knowledgecenter')">
            ...
            <div class="body">
                <div class="row col-sm-12" id="viewcommunity">
                        ...
                        <div class="col-sm-3 col_img">
                            ...
                            <ul id="right_icon">
                                <li> <a href="javascript:void(0)" data-id="<?php echo $content['id']?>" data-toggle="modal" data-target="#editknowledge" class="editknowcenter" id="editknow" ><i class="fa fa-edit"></i></a></li>
                                <li> <a href="javascript:void(0)" data-id="<?php echo $content['id']?>" data-url="../delete" class=" js-sweetalert " title="Delete" data-str="Knowledge Community" data-type="confirm"><i class="fa fa-trash"></i></a></li>
                                <li> <a href="<?=$baseurl?>knowledgeCenter/view/<?php echo md5($content['id']) ?>" target="_blank" class="viewknow" ><i class="fa fa-eye"></i></a></li>
                            </ul>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header header">
                  <h6 class="title" id="defaultModalLabel"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '760') { echo $langlbl['title'] ; } } ?></h6>
		  <button type="button" class=" close" data-dismiss="modal">
            ...
            <div class="modal-body">
                           <?php   
                echo $this->Form->create(false , ['url' => ['action' => 'addcommunity'] , 'id' => "addcommunityform" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                <div class="row clearfix">
...
<div class="modal classmodal animated zoomIn" id="editknowledge" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header header">
                  <h6 class="title" id="defaultModalLabel"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1466') { echo $langlbl['title'] ; } } ?></h6>
		  <button type="button" class=" close" data-dismiss="modal">
  		   <span aria-hidden="true">&times;</span>
		  </button>
	    </div>
            <div class="modal-body">
                <?php echo $this->Form->create(false , ['url' => ['action' => 'editcommunity'] , 'id' => "editcommunityform" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                <div class="row clearfix">
                    ...
                    <div class="col-sm-6">
                        <label><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '136') { echo $langlbl['title'] ; } } ?>*</label>
                        <div class="form-group">
                            <select class=" form-control class_s" id="eguid_class" name="eguid_class" required>
                                <?php foreach($cls_details as $clsdtl) {
                                    if($added_for == "kinder" && ($clsdtl['school_sections'] == "Creche" || $clsdtl['school_sections'] == "Maternelle"))
                				    {
                				        echo '<option value="'.$clsdtl['c_name'].'-'.$clsdtl['school_sections'].'">'.$clsdtl['c_name'].'-'.$clsdtl['school_sections'].'</option>';
