...
foreach($lang_label as $langlbl) { 
    ...
    if($langlbl['id'] == '1215') { $lbl1215 = $langlbl['title'] ; }
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <!--<h2 class="align-right"><a href="#" class="btn btn-success" onclick="closeCalendar()"><i class="fa fa-calendar"></i> <?= $lbl1215 ?></a></h2>-->
                <ul class="header-dropdown">
                    <li><a href="javascript:void(0)" title="Back" class="btn btn-sm btn-success" onclick="goBack()"><?php echo $labl41 ?></a></li>
                </ul>
            </div>
