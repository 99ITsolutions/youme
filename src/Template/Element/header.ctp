...
if(!empty($company_details[0]['comp_name']) && !empty($user_details)){
	...
	$color = $parent_details[0]['company']['primary_color'];
	$btncolor = $parent_details[0]['company']['button_color'];
    $loginas = "parent";
}
...
else if(!empty($company_details[0]['comp_name']) && !empty($user_details)){
    $title = $company_details[0]['comp_name'];
    $color = $company_details[0]['primary_color'];
    $btncolor = $company_details[0]['button_color'];
    $loginas = "superschool";
...
$youmelink = "https://you-me-globaleducation.org/";
?>
<!doctype html>
...
<?php }
elseif(!empty($parent_details[0]['company']['favicon']))
{ ?>
    <link rel="icon" href="<?=$baseurl."img/".$parent_details[0]['company']["favicon"]?>" type="image/x-icon">
<?php }
...
<?php 
if($btncolor == "#d32191" || $btncolor == "#6b73d5" || $btncolor == "#01319d"  || $btncolor == "#438ccc" || $btncolor == "#000036" || $btncolor == "#800080" || $btncolor == "#560319" || $btncolor == "#666699" ) { 
?>
<style>
...
<?php
if($color == "#d32191" || $color == "#6b73d5" || $color == "#01319d"  || $color == "#438ccc" || $color == "#000036" || $color == "#800080" || $color == "#560319" || $color == "#666699") {
?>
<style>
#left-sidebar {
    background: <?= $color?> !important;
    ...
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid col-md-12 col-sm-12">
            ...
            <div class="navbar-brand col-md-3 col-sm-5">
                <img src="https://you-me-globaleducation.org/you-meheaderlogo.png" alt="You-Me Global Education Logo" class="img-responsive logo"  style =" width:220px; max-height: 85px; " alt="School Logo">
                <input type="hidden" id="loginas" value= "<?= $loginas ?>">
            </div>
            <div class="navbar-center col-md-4 col-sm-6" style=" text-align:center">
                <!--<img src="http://you-metechnologies.com/youme-logo.png" alt="You-Me Global Education Logo" class="img-responsive logo" width=225px>-->
                <?php 
                ...
                <?php }
                            ...
                            <img src='<?=$baseurl."img/".$student_details[0]['company']["comp_logo"]?>' style =" width:110px; max-height: 85px; " alt="School Logo" class="img-responsive logo">
                            <p><?= $student_details[0]['company']["comp_name"]?></p>
                <?php }
                    /*elseif(!empty($parent_details[0])){ ?>
                            <a href="<?=$baseurl?>"><img src='<?=$baseurl."img/".$parent_details[0]['company']["comp_logo"]?>' style =" width:110px; max-height: 85px; " alt="School Logo" class="img-responsive logo"></a>
                            <p><?= $parent_details[0]['company']["comp_name"]?></p>
                <?php }*/
                   elseif(!empty($emp_details[0])){ ?>
                            <img src='<?=$baseurl."img/".$emp_details[0]['company']["comp_logo"]?>'  style =" width:110px; max-height: 85px; " alt="School Logo" class="img-responsive logo">
                            <p><?= $emp_details[0]['company']["comp_name"]?></p>
                <?php }
                elseif(!empty($sclsub_details[0])){ ?>
                        <img src='<?=$baseurl."img/".$sclsub_details[0]['company']["comp_logo"]?>'  style =" width:110px; max-height: 85px; " alt="School Logo" class="img-responsive logo">
                        <p><?= $sclsub_details[0]['company']["comp_name"]?></p>
                <?php }
                /* elseif(!empty($user_details[0])) { ?>
                        <a href="<?=$baseurl?>"><img src="http://you-metechnologies.com/3D-white-background.png" alt="You-Me Global Education Logo" class="img-responsive logo" width=150px></a>  
                 <?php } */?>
            </div>
            <div class="navbar-right col-md-4 col-sm-6">
                <div id="google_translate_element" class="pull-right" style="display:none"></div>
                <div id="navbar-menu">
                        ...
                        <li>
                            <div class="user-account" style="display:block; text-align:center">
			                    <?php 
                                    ...
                                    /*elseif (!empty($parent_details[0]['pic'])) 
                                    {
                                        ?>
                                            <img src="<?=$baseurl."img/".$parent_details[0]["pic"]?>" height="50" widht="50" class="rounded-circle user-photo" alt="Student pic"> 
                                        <?php
                                    }*/
                                    else
                                    {  ?>
                                    ...
                                    <div class="dropdown" style="display:block">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-toggle user-name" data-toggle="dropdown"><strong>
                                            <?php 
                                               ...
                                               /* elseif(!empty($parent_details[0]))
                                                {
                                                    echo $parent_details[0]['f_name']." ". $parent_details[0]['l_name'];
                                                } */
                                                elseif(!empty($sclsub_details[0]))
                                                {
                                                    echo $sclsub_details[0]['fname']." ".$sclsub_details[0]['lname']." (".$sclsub_details[0]['jobtitle'].")";
                                                }
                                            ?>
                                        </strong></a>                    
                                        <ul class="dropdown-menu dropdown-menu-right account animated flipInY">
                                            <li>
                                                ...
                                                if(!empty($company_details[0]))
                                                { ?>
                                                   <a href="<?=$baseurl?>schools/profile/<?=md5($company_details[0]['id'])?>"><i class="icon-user"></i><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '601') { echo $langlbl['title'] ; } } ?></a>
                                                <?php }
                                                elseif(!empty($emp_details[0]))
                                                { ?>
                                                   <a href="<?=$baseurl?>employee/profile/<?=md5($emp_details[0]['id'])?>"><i class="icon-user"></i><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '601') { echo $langlbl['title'] ; } } ?></a>
                                                <?php }
                                                elseif(!empty($student_details[0]))
                                                { ?>
                                                   <a href="<?=$baseurl?>students/profile/<?=md5($student_details[0]['id'])?>"><i class="icon-user"></i><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '601') { echo $langlbl['title'] ; } } ?></a>   
                                                <?php 
                                                } 
                                                /* elseif(!empty($parent_details[0]))
                                                { ?>
                                                   <a href="<?=$baseurl?>parents/profile/<?=md5($parent_details[0]['id'])?>"><i class="icon-user"></i><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '601') { echo $langlbl['title'] ; } } ?></a>   
                                                <?php 
                                                } */
                                                elseif(!empty($sclsub_details[0]))
                                                { ?>
                                                   <a href="<?=$baseurl?>schoolSubadmin/profile/<?=md5($sclsub_details[0]['id'])?>"><i class="icon-user"></i><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '601') { echo $langlbl['title'] ; } } ?></a>   
                                                <?php 
                                                } 
                                                ?>
                                            ...
                                            <li>
                                                ...
                                                if(!empty($company_details[0]))
                                                { ?>
                                                   <a href="<?=$baseurl?>logout"><i class="icon-power"></i><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '602') { echo $langlbl['title'] ; } } ?></a>
                                                <?php }
                                                elseif(!empty($emp_details[0]))
                                                { ?>
                                                   <a href="<?=$baseurl?>logoutk"><i class="icon-power"></i><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '602') { echo $langlbl['title'] ; } } ?></a>
                                                <?php }
                                                elseif(!empty($student_details[0]))
                                                { ?>
                                                   <a href="<?=$baseurl?>logouts"><i class="icon-power"></i><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '602') { echo $langlbl['title'] ; } } ?></a>   
                                                <?php } 
                                               /* elseif(!empty($parent_details[0]))
                                                { ?>
                                                   <a href="<?=$baseurl?>logout"><i class="icon-power"></i><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '602') { echo $langlbl['title'] ; } } ?></a>   
