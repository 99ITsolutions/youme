  ...
  white-space: inherit;
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2 class="heading"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '788') { echo $langlbl['title'] ; } } ?></h2>
                        <ul class="header-dropdown">
                            <li><a href="javascript:void(0)"  title="Delete All" data-str= "Local University Queries" data-url = "queries/deleteallunivqueries"  id="deletealluniqueries" class="btn btn-sm btn-success deletealluniqueries"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1532') { echo $langlbl['title'] ; } } ?></a></li>
                                ...
                                <tbody id="univbody" class="modalrecdel">
                                    <?php foreach($queries_details as $query) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" data-id="<?=$query['id']?>" data-url="deleteunivqueries" class="btn btn-sm btn-outline-danger js-sweetalert " title="Delete" data-str="Local Univesity Queries" data-type="confirm"><i class="fa fa-trash-o"></i></button>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
