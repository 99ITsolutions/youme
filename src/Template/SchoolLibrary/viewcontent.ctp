        ...
        <div class="card">
            <div class="header">
                ...
                <div class="row">
                    ...
                    -->
                    <h2 class="col-lg-1 align-right"><a href="<?=$baseurl?>SchoolLibrary" title="Back"  class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></h2>
                </div>
                <?php } else {?>    
            ...
            <div class="body">
                <div class="row clearfix mb-4">
                    ...
                    if($content_details[0]['file_type'] == "pdf")
                    {
                        ...
                        <!--<iframe src='https://you-me-globaleducation.org/school/img/<?php echo $content_details[0]['links'] ?>' height='600px' width="100%" style="left:0px !important; position:inherit !important;"></iframe>-->
                        </div>
                        <?php
                    }
                    ?>
                				...
                				<?php if (count($comments_details) != 0): ?>
                    				...
                    				<div class="comment clearfix">
                    					...
                    					<div class="comment-details">
                    						...
                    						<a class="schoollib_reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1488') { echo $langlbl['title'] ; } } ?></a>
                    					</div>
                    					<div class="col-sm-12 clearfix">
