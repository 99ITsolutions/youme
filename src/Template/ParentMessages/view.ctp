...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <h1 style="font-size:24px"><a href="<?=$baseurl?>ParentMessages" title="Add" class="btn btn-sm btn-default" style="float:right"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1370') { echo $langlbl['title'] ; } } ?></a>  <?php if(count($all_messages) > 1){ ?><b>Re: </b><?php } ?><?= $get_messages->subject ?></h1>
            </div>
                                ...
                                <div class="from_student">
                                    <div class="row mb-2">
                                        <div class="col-md-12 text-left">
                                            <?php if($value['student_no'] == "") {?>
                                            <h3 class="school_name"><b><?=$value['sender']?></b></h3>
                                            <?php } else { ?>
                                            <h3 class="school_name"><b><?=$value['sender']." - ". $value['student_no']. " (Class: ". $value['classname'] . ")"?></b></h3>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="row ">
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12 text-right">
                                            ...
                                            <p><?= date('M d, Y H:i', $value->read_datetime) ?> <b>(Read)</b></p>
                                            <?php } else { ?>
                                            <p><?php //echo date('M d, Y H:i', $value->created_date) ?> <b>(Delivered)</b></p>
                                            <?php } ?>
                                        </div>
                                    </div>
                                ...
                                <div class="from_school">
                                    <div class="row mb-2">
                                        <div class="col-md-12 text-left">
                                            ...
                                            <?php } else { ?>
                                            <h3 class="student_name"><b><?=$value['sender']." - ". $value['student_no']. " (Class: ". $value['classname'] . ")"?></b></h3>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="row ">
    ...
    $(this).ajaxSubmit({
        ...
        success: function(response){
            ...
            if(response.result === "success" ){ 
                setTimeout(function(){ location.href = baseurl +"/ParentMessages/view/<?= base64_encode($id) ?>" ;  }, 1000);
