            ...
            <div class="header">
                ...
                <ul class="header-dropdown">
                    ...
                    { 
                        ...
                        if(in_array("86", $roles)) { ?>
                            <li><a href="<?=$baseurl?>Contactyoume/add" title="Add" class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1380') { echo $langlbl['title'] ; } } ?></a></li>
		                <?php }
                    } else { ?>
                        <li><a href="<?=$baseurl?>Contactyoume/add" title="Add" class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1380') { echo $langlbl['title'] ; } } ?></a></li>
                    <?php } ?>
                    ...
                    <table class="table table-hover js-basic-example dataTable table-custom table-striped m-b-0 c_list default_pageitem" id="feestruc_table" data-page-length='50'>
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '2010') { echo $langlbl['title'] ; } } ?></th>
                                ...
                                <tr>
                                   <td class="width45">
                                    ...
                                    <td>
                                        ...
                                        { 
                                            $roles = explode(",", $sclsub_details[0]['sub_privileges']); 
                                            if(in_array("87", $roles)) { ?>
                                                <a href="<?=$baseurl?>Contactyoume/view/<?= base64_encode($value['id']) ?>"  class="btn btn-sm btn-outline-secondary" title="View"><i class="fa fa-eye"></i></a>
                    		                <?php }
                                        } else { ?>
                                            <a href="<?=$baseurl?>Contactyoume/view/<?= base64_encode($value['id']) ?>"  class="btn btn-sm btn-outline-secondary" title="View"><i class="fa fa-eye"></i></a>
                                        <?php } ?>
