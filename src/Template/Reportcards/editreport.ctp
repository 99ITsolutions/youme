    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header row">
                ...
                <h2 class="col-md-6 align-right"><a href="<?= $baseurl ?>classes/classall?classid=<?=$_GET['classid'];?>" title="Back" class=" btn btn-primary" ><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1162') { echo $langlbl['title'] ; } } ?> </a></h2>
            </div>
...
<div class="col-md-8">
  <div class="main-head">
   <h3 style="font-size:  29px !important; color: #000;line-height: 42px;text-transform: uppercase;font-weight: 600;">Republique Democratique Du Congo
...
<div class="pol-md-12">
  <table id="example" cellpadding="0" cellspacing="0" class="display nowrap no-footer head-bot" style="width: 100%;" role="grid" aria-describedby="example_info">
                 ...
                 <?php }else{ ?>
                        ...
                        ?>     
                        <td><input type="text" name="nid[]" value="<?=$val;?>" maxlength="1" required="required" style="font-weight: bold;"></td>
                        <?php }  ?>
                <?php } ?>
...
<tr class="prov-td">
  ...
  <td style="border-right: 2px solid #333 !important;"><input type="text" name="province" value="<?=$report_marks['province'];?>" required="required" class="" style="width: 100%; font-weight:bold;"></td>
</tr>
</tbody>
                                    </table>
</div>
...
<div class="ville-bot">
<input type="text" name="" value="<?=$school_name['city'];?>" style="font-weight: bold;">
</div>
</div>
...
<div class="ville-bot">
<input type="text" name="" value="<?=$school_name['ph_no'];?>" style="font-weight: bold;">
...
<div class="ville-bot">
<input type="text" name="" value="<?=$school_name['comp_name'];?>" style="font-weight: bold;">
</div>
</div>
...
<table id="example" class="display nowrap dataTable no-footer head-bot" style="width: 100%; margin-top: 6px;" role="grid" aria-describedby="example_info">
                    ...
                    <?php if($report_marks['code'] == ""){?>     
                      ...
                      <?php }else{ ?>
                        ...
                        ?>     
                        <td><input type="text" name="code[]" maxlength="1" value="<?=$val;?>" required="required" style="font-weight: bold;"></td>
                        <?php }  ?>
                <?php } ?>   
                      </tr>
...
<div class="ville-bot">
<input type="text" name="studentname" style="font-weight: bold;" value="<?php echo $student_name['f_name'];?> <?php echo $student_name['l_name'];?>">
</div>
</div>
</div>
...
<div class="ville-bot">
<input type="text" name=""  value="<?php echo $student_name['gender'];?>">
</div>
</div>
</div>
...
<div class="ville-bot">
<input type="text" name="neea" value="<?=$report_marks['neea'];?>" style="font-weight: bold;"  required="required">
</div>
</div>
</div>
...
<?php }else{?> 
<input type="text" name="lethe[]" maxlength="2" value="<?=$exlethe[0];?>" style="font-weight: bold;" required="required">
<?php } ?>
</div>
<div class="lable">
/
...
<input type="text" name="lethe[]" maxlength="2" required="required">
<?php }else{?> 
<input type="text" name="lethe[]" maxlength="2" value="<?=$exlethe[1];?>" style="font-weight: bold;" required="required">
<?php } ?>
</div>
...
<input type="text" name="lethe[]" maxlength="2" required="required">
<?php }else{?> 
<input type="text" name="lethe[]" maxlength="2" value="<?=$exlethe[2];?>" style="font-weight: bold;" required="required">
<?php } ?>
</div>
</div>
</div>
...
<div class="ville-bot">
<input type="text" name="eleve" value="<?=$report_marks['eleve'];?>" style="font-weight: bold;" required="required">
</div>
</div>
</div>
<div class="col-md-12">
...
<table id="example" class="display nowrap dataTable no-footer head-bot" style="width: 100%;    margin-top: 6px;" role="grid" aria-describedby="example_info">
                        ...
                        ?>     
                        <td><input type="text" name="nperm[]" value="<?=$val;?>" maxlength="1" required="required" style="font-weight: bold;"></td>
                        <?php }  ?>
                <?php } ?> 
                      </tr>
...
<div class="pol-md-4 border-left-inn">
  <label style="margin-bottom: 0;">TRAVAUX</label><br>
   <label>Journal</label>
...
">
 <div class="pol">
 <div class="pol-md-2">
  <input type="number" name="max1[]" class="max1" id="highmarks<?=$i;?>" value="<?=$marks[$i];?>"  min="0">
 </div>
<div class="pol-md-2 border-left-sub">
  <?php if($arrmax2[$d] == "0"){?>
  <input type="number" name="max2[]" class="max2 mymarks1<?=$i;?>" id="<?=$i;?>" value="<?=$arrmax2[$d];?>" min="0" style="width: 60px;text-align: center;">
  <?php }else{ ?>  
  <input type="number" name="max2[]" class="max2 mymarks1<?=$i;?>" id="<?=$i;?>" value="<?=$arrmax2[$d];?>" min="0" style="width: 60px;text-align: center;">
  <?php } ?>
 </div>
 <div class="pol-md-2 border-left-sub">
   <?php if($arrmax3[$d] == "0"){?>
   <input type="number" name="max3[]" class="max3 mymarks2<?=$i;?>" id="<?=$i;?>" value="<?=$arrmax3[$d];?>" min="0" style="width: 60px;text-align: center;">
   <?php }else{ ?>  
    <input type="number" name="max3[]" class="max3 mymarks2<?=$i;?>" id="<?=$i;?>" value="<?=$arrmax3[$d];?>" min="0" style="width: 60px;text-align: center;">
   <?php } ?>
...
<div class="pol-md-3 border-left-sub">
 ...
 <div class="pol-md-6 ">
 <input type="number" name="max21[]" class="max21" id="highmarks2<?=$i;?>" value="<?=$marks[$i]*2;?>" min="0">
 </div>
 <div class="pol-md-6 border-left-sub">
    <?php if($arrmax22[$d] == "0"){?>
 <input type="number" name="max22[]" class="max22 mymarks3<?=$i;?>" id="<?=$i;?>" value="<?=$arrmax22[$d];?>" min="0" style="width: 45px;text-align: center;">
    <?php }else{ ?>
  <input type="number" name="max22[]" class="max22 mymarks3<?=$i;?>" id="<?=$i;?>" value="<?=$arrmax22[$d];?>" min="0" style="width: 45px;text-align: center;">    
     <?php } ?>
 </div>
 ...
 <div class="pol-md-3 border-left-sub border-left-subhalf">
  <div class="pol border-inner-subect2">
 <div class="pol-md-6 ">
 <input type="number" name="maxtot[]" class="maxtot  mymaxtot<?=$i;?>" value="" min="0">
 </div>
 <div class="pol-md-6 border-left-sub">
   <input type="number" name="maxgettot[]" class="maxgettot mymaxget<?=$i;?>" value="" min="0" style="width: 44px; text-align: center;">
 </div>
</div>
 </div>
</div>
...
">
 <div class="pol">
 <div class="pol-md-2">
   <input type="number" name="nmax1[]" class="nmax1" id="nhighmarks<?=$i;?>" value="<?=$marks[$i];?>" min="0">
 </div>
<div class="pol-md-2 border-left-sub">
  <?php if($arrnmax2[$d] == "0"){?>  
  <input type="number" name="nmax2[]" class="nmax2 nmymarks1<?=$i;?>" id="<?=$i;?>" value="<?=$arrnmax2[$d];?>" min="0" style="width: 60px; text-align: center;">
 <?php }else{ ?>
  <input type="number" name="nmax2[]" class="nmax2 nmymarks1<?=$i;?>" id="<?=$i;?>" value="<?=$arrnmax2[$d];?>" min="0" style="width: 60px; text-align: center;">
 <?php } ?> 
 </div>
 <div class="pol-md-2 border-left-sub">
   <?php if($arrnmax3[$d] == "0"){?>  
  <input type="number" name="nmax3[]" class="nmax3 nmymarks2<?=$i;?>" id="<?=$i;?>" value="<?=$arrnmax3[$d];?>" min="0" style="width: 60px;text-align: center;">
   <?php }else{ ?>
     <input type="number" name="nmax3[]" class="nmax3 nmymarks2<?=$i;?>" id="<?=$i;?>" value="<?=$arrnmax3[$d];?>" min="0" style="width: 60px;text-align: center;">
   <?php } ?>  
 </div>
<div class="pol-md-3 border-left-sub">
  <div class="pol border-inner-subect2">
 <div class="pol-md-6 ">
  <input type="number" name="nmax21[]" class="nmax21" id="nhighmarks2<?=$i;?>" value="<?=$marks[$i]*2;?>" min="0">
 </div>
 <div class="pol-md-6 border-left-sub">
<?php if($arrnmax22[$d] == "0"){?>    
 <input type="number" name="nmax22[]" class="nmax22 nmymarks3<?=$i;?>" id="<?=$i;?>" value="0" min="0" style="width: 45px; text-align: center;">
 <?php }else{ ?>
<input type="number" name="nmax22[]" class="nmax22 nmymarks3<?=$i;?>" id="<?=$i;?>" value="<?=$arrnmax22[$d];?>" min="0" style="width: 45px; text-align: center;">
  <?php } ?>    
 ...
 <div class="pol-md-3 border-left-sub border-left-subhalf">
  <div class="pol border-inner-subect2">
 <div class="pol-md-6 ">
<input type="number" name="nmaxtot[]" class="nmaxtot mynmaxtot<?=$i;?>" value="" min="0">
 </div>
 <div class="pol-md-6 border-left-sub">
   <input type="number" name="nmaxgettot[]" class="nmaxgettot mynmaxget<?=$i;?>" value="" min="0" style="width: 45px; text-align: center;">
 </div>
</div>
 </div>
</div>
...
">
 <div class="pol">
 <div class="pol-md-2">
  <input type="text" name="totalmax1" value="<?=array_sum($marks);?>" class="font-weight" id="totalmax1" >
 </div>
<div class="pol-md-2 border-left-sub">
  <input type="text" name="totalmax2" class="font-weight" id="totalmax2" value="">
 </div>
 <div class="pol-md-2 border-left-sub">
  <input type="text"  name="totalmax3" class="font-weight" id="totalmax3" value="">
 </div>
<div class="pol-md-3 border-left-sub">
  <div class="pol border-inner-subect2">
 <div class="pol-md-6 ">
  <input type="text" name="totalmax21" value="<?=array_sum($marks)*2;?>" class="font-weight" id="totalmax21">
 </div>
 <div class="pol-md-6 border-left-sub">
  <input type="text" name="totalmax22" class="font-weight" id="totalmax22" value="">
 </div>
</div>
 </div>
 <div class="pol-md-3 border-left-sub border-left-subhalf">
  <div class="pol border-inner-subect2">
 <div class="pol-md-6 ">
<input type="text" name="hightotalmax" class="font-weight" id="totalhighmax" value="">
 </div>
 <div class="pol-md-6 border-left-sub">
   <input type="text" name="gettotalmax" class="font-weight" id="totalgetmax" value="">
 </div>
</div>
 </div>
</div>
...
">
 <div class="pol">
 <div class="pol-md-2">
  <input type="text" name="ntotalmax1" value="<?=array_sum($marks);?>" class="font-weight" id="ntotalmax1" >
 </div>
<div class="pol-md-2 border-left-sub">
  <input type="text" name="ntotalmax2" class="font-weight" id="ntotalmax2" value="">
 </div>
 <div class="pol-md-2 border-left-sub">
  <input type="text" name="ntotalmax3" class="font-weight" id="ntotalmax3" value="">
 </div>
<div class="pol-md-3 border-left-sub">
  <div class="pol border-inner-subect2">
 <div class="pol-md-6 ">
 <input type="text" name="ntotalmax21" value="<?=array_sum($marks)*2;?>" class="font-weight" id="ntotalmax21">
 </div>
 <div class="pol-md-6 border-left-sub">
 <input type="text" name="ntotalmax22" class="font-weight" id="ntotalmax22" value="">
 </div>
</div>
 </div>
 <div class="pol-md-3 border-left-sub border-left-subhalf">
  <div class="pol border-inner-subect2">
 <div class="pol-md-6 ">
  <input type="text" name="nhightotalmax" class="font-weight" id="ntotalhighmax" value="">
 </div>
 <div class="pol-md-6 border-left-sub">
   <input type="text" name="ngettotalmax" class="font-weight" id="ntotalgetmax" value="">
 </div>
</div>
 </div>
</div>
...
<div class="text-center" style="margin-bottom: 20px;font-size: 16px;">
  <input type="radio" name="status" value="1" style="width: auto;height: auto;" <?php if($report_marks['status'] == 1){?> checked="checked" <?php } ?>> Submit Report 
  &nbsp;&nbsp;&nbsp; 
  <input type="radio"  name="status" value="0" style="width: auto;height: auto;" <?php if($report_marks['status'] == 0){?> checked="checked" <?php } ?>> Send to Class Teacher for correction
</div>

<div class="text-center">
  <input type="submit" class="btn report-but-yel" name="adddata" value="Update">
</div>
