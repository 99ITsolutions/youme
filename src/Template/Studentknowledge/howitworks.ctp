...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
				<div class="row">
				    <input type="hidden" id="addedfor" name="addedfor" value="student">
				    <input type="hidden" name="addedfor" id="added_for" value="student" >
				    <input type="hidden" id="clsfilter" value="" >
				    <h2 class="col-lg-6 heading"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1449') { echo $langlbl['title'] ; } } ?></h2>
				    <ul class="header-dropdown">
                        
                        <li style="width:160px; padding:0px 10px">
                            <select class=" form-control community_filter" id="comm_filter" onchange="stud_howitworks_filter(this.value)">
                ...
                <div class="row mt-4">
                    <div class="col-md-3 ">
                        <select class="form-control js-states chosetitle" id="title_filter" onchange="studtitle_filter(this.value, 'howitworks')">
            ...
            <div class="body">
                <div class="row col-sm-12" id="viewcommunity">
                        ...
                        <div class="col-sm-2 col_img">
                            <a href="<?=$baseurl?>Studentknowledge/viewhowitworks/<?php echo md5($content['id']) ?>" class="viewknow" >
