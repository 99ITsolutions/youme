    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
				<div class="row">
				    ...
				    <ul class="header-dropdown">
                        ...
                        <li style="width:160px; padding:0px 10px">
                            <select class=" form-control community_filter" id="comm_filter" onchange="stud_leadership_filter(this.value)">
                        ...
                        <li>
                            <a href="javascript:void(0);" title="Contact Us" class="btn btn-info" data-toggle="modal" data-target="#leadercontactpop"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '46') { echo $langlbl['title'] ; } } ?></a>
                        </li>
                ...
                <div class="row mt-4">
                    <div class="col-md-3 ">
                        <select class="form-control js-states chosetitle" id="title_filter" onchange="studetitle_filter(this.value, 'leadership')">
            ...
            <div class="body">
                <div class="row col-sm-12" id="viewcommunity">
                        ...
                        <div class="col-sm-2 col_img">
                            <a href="<?=$baseurl?>Studentknowledge/viewleadership/<?php echo md5($content['id']) ?>" class="viewknow" >
