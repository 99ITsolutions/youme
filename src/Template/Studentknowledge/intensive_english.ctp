                    ...
                    <div class="body" id="knowledgecenter">
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="<?= $baseurl ?>Studentknowledge/kg_intensive_english">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a  href="<?= $baseurl ?>Studentknowledge/primary_intensive_english">
                                <div class="card text-center bg-dash">
                                    <div class="body">
                                        <div class="p-15 text-light">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="<?= $baseurl ?>Studentknowledge/highscl_intensive_english">
                                <div class="card text-center bg-dash">
                                    <div class="body">
                                        <div class="p-15 text-light">
