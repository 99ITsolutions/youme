        ...
        <div class="card">
            <div class="header">
                ...
                <div class="row">
                    ...
                    <h2 class="col-lg-1 align-right"><a href="<?=$baseurl?>studentknowledge/newtechnologies" title="Back"  class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></h2>
                </div>
                <?php }
                ...
                <div class="row clearfix mb-4">
                    ...
                    <div class="col-sm-12 mt-3">
                        ...
                        <div class="col-sm-12 col-sm-offset-1 comments-section">
                			...
                			<?php echo $this->Form->create(false , ['url' => ['action' => 'addtechnologiescomment'] , 'id' => "comment_form" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                				...
                				<?php if (count($comments_details) != 0): ?>
                    				...
                    				<div class="comment clearfix">
                    					...
                    					<div class="comment-details">
                    						...
                    						<a class="studntcomm_reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1488') { echo $langlbl['title'] ; } } ?></a>
                    					</div>
                    					<div class="col-sm-12 clearfix">
                    					...
                    					<!-- reply form -->
                    					<form class="reply_form clearfix" id="studnewtechnocomment_reply_form_<?php echo $comment['id'] ?>" data-id="<?php echo $comment['id']; ?>">
