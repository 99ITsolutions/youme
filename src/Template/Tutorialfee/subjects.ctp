	           ...
	           <div class="body">
	                <div class="row clearfix">
                        ...
                        { 
    	                    ...
    	                    <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="card text-center bg-dash ">
                                    <a  class="colorBtn" href="<?=$baseurl?>tutorialfee/add/<?= $empdtl['class']['id'] ?>/<?= $empdtl['subjects']['id'] ?>" class="teachersubdtldata" >
	                    ...
	                    { 
    	                    ...
    	                    <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="card text-center bg-dash ">
                                    <a  class="colorBtn" href="<?=$baseurl?>tutorialfee/add/<?= $gradeids[$key] ?>/<?= $subjectids[$key] ?>" class="teachersubdtldata" >
                                        <div class="body" style="height:90px !important;">
                                            <div class="p-15 text-light teachersubdtlss">
