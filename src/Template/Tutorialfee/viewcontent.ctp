        ...
        <div class="card">
            <div class="header">
                ...
                <div class="row">
                    ...
                    <h2 class="col-lg-1 align-right"><a href="<?=$baseurl?>tutorialfee/add/<?= $content_details[0]['class_id'] ?>/<?= $content_details[0]['subject_id'] ?>" title="Back"  class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></h2>
                </div>
                <?php } else {?>    
            ...
            <div class="body">
                <div class="row clearfix mb-4">
                    ...
                    if($content_details[0]['file_type'] == "audio")
                    {
                        ...
                        <?php } else { ?>
                            <div class="col-sm-4 text-center" style="padding-top:150px; background: url(https://www.you-me-globaleducation.org/youme-logo.png)no-repeat center; max-width: 350px; height: 400px; border: 1px solid; text-align: center !important;">
                        ...
                        <?php if (count($comments_details) != 0): ?>
                            ...
                            <div class="comment clearfix">
                              ...
                              <div class="comment-details">
                                ...
                                <a class="tcomm_reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1488') { echo $langlbl['title'] ; } } ?></a>
                              </div>
                              <div class="col-sm-12 clearfix">
                              ...
                              <!--  <input type="text" class="form-control" name="reply_text" id="reply_text" >-->
                                ...
                                <button class="btn btn-primary btn-xs pull-right tsubmit-reply"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1494') { echo $langlbl['title'] ; } } ?></button>
                              </div>
