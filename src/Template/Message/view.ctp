...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <h1 style="font-size:24px"><?php if(count($all_messages) > 1){ ?><b>Re: </b><?php } else { ?> <b><?= $tpclbl ?>: </b> <?php } ?><?= $get_messages->subject ?></h1>
            </div>
            <div class="body container">
                <?php foreach($all_messages as $value){ 
                    if($value['from_type'] == "student")
                    {
                    ?>
                                ...
                                <div class="from_student">
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12 text-right">
                                            ...
                                            <?php } else { ?>
                                            <p><?php //echo date('M d, Y H:i', $value->created_date) ?> <b>(<?= $delivr ?>)</b></p>
                                            <?php } ?>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="widget-area no-padding blank" id="widget_box_sh" style="display:none">
							<div class="status-upload">
								<?php echo $this->Form->create(false , ['url' => ['action' => 'addmessage'] , 'id' => "sendreply" , 'method' => "post"  ]); ?> 
    ...
    $(this).ajaxSubmit({
        ...
        success: function(response){
            ...
            if(response.result === "success" ){ 
                setTimeout(function(){ location.href = baseurl +"/message/view/<?= base64_encode($id) ?>" ;  }, 1000);
