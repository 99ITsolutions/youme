...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <?php 
                if($knowledge_details[0]['added_for'] == "latinphilo")
			    {
	                $backbutn =  'latinphilo_stateexam' ;
			    }
			    elseif($knowledge_details[0]['added_for'] == "commerciale")
			    {
			        $backbutn = 'commerciale_stateexam'; 
			    }
			    elseif($knowledge_details[0]['added_for'] == "mathphy")
			    {
			        $backbutn = 'mathphy_stateexam'; 
			    }
			    elseif($knowledge_details[0]['added_for'] == "chembio")
			    {
			        $backbutn = 'chembio_stateexam'; 
			    }
			    elseif($knowledge_details[0]['added_for'] == "general")
			    {
			        $backbutn = 'general_stateexam'; 
			    }
			    elseif($knowledge_details[0]['added_for'] == "techniques")
			    {
			       $backbutn =  'techniques_stateexam' ;
			    }
                ...
                <div class="row">
                   ...
                   <!--<h2 class="col-lg-2 align-right"><a href="<?=$baseurl?>img/<?php echo $knowledge_details[0]['links']?>" title="Download PDF" download class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1492') { echo $langlbl['title'] ; } } ?></a></h2>-->
                    ...
                    <h2 class="col-lg-1 align-right"><a href="<?=$baseurl?>teacherknowledge/<?= $backbutn ?>" title="Back"  class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></h2>
                </div>
                <?php }
                ...
                <div class="row clearfix mb-4">
                    ...
                    <div class="col-sm-12 mt-3">
                        ...
                        <div class="col-sm-12 col-sm-offset-1 comments-section">
                			...
                			<?php echo $this->Form->create(false , ['url' => ['action' => 'addstatecomment'] , 'id' => "comment_form" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                				...
                				<?php if (count($comments_details) != 0): ?>
                    				...
                    				<div class="comment clearfix">
                    					...
                    					<div class="comment-details">
                    						...
                    						<a class="tchrsecomm_reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1488') { echo $langlbl['title'] ; } } ?></a>
                    					</div>
                    					<div class="col-sm-12 clearfix">
                    					...
                    					<!-- reply form -->
                    					<form class="reply_form clearfix" id="tchrstexmcomment_reply_form_<?php echo $comment['id'] ?>" data-id="<?php echo $comment['id']; ?>">
    ...
    $database = "youmeglo_globalweb";
                    					...
                    					$replies = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `state_exam_comments` WHERE parent = '".$comment['id']."'")) ?>
