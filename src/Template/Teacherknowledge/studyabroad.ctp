                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown">
                            ...
                            <li><a href="<?= $baseurl ?>teacherknowledge" class="btn btn-info" ><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></li>
                        </ul>
                    </div>
                    <div class="body">
                                            ...
                                            <td>
                                                <p>
                                                    ...
                                                    <span style="width:13%; float:right;">
                                                        <a href="javascript:void(0);" data-id="<?= $uni['id'] ?>" data-uniname="<?= $uni['univ_name'] ?>" data-logo = "<?= $uni['logo'] ?>" class="btn btn-success youmecontct" title="Contact Form"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '46') { echo $langlbl['title'] ; } } ?></a>
                                                    </span>
                                                </p>
                                                <?php 
