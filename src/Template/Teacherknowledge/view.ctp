        ...
        <div class="card">
            <div class="header">
                ...
                <div class="row">
                    ...
                    <h2 class="col-lg-1 align-right"><a href="<?=$baseurl?>teacherknowledge/community" title="Back"  class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></h2>
                </div>
                <?php } else {?>    
                <div class="row">
                    <h2 class="col-lg-11 align-left heading" style="font-size:20px !important; "><?= ucwords($knowledge_details[0]['title']) ?></h2>
                        ...
                        <div class="col-sm-12 col-sm-offset-1 comments-section">
                			...
                			<?php echo $this->Form->create(false , ['url' => ['action' => 'addcomment'] , 'id' => "comment_form" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                				...
                				<div class="col-sm-9" style="float:left">
                				    ...
                				    <input type="hidden" name="schoolid" id="school_id" value="<?= $school_id ?>" >
                				...
                				<?php if (count($comments_details) != 0): ?>
                    				...
                    				<div class="comment clearfix">
                    					...
                    					<div class="comment-details">
                    						...
                    						<a class="teacher_reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1488') { echo $langlbl['title'] ; } } ?></a>
                    					</div>
                    					<div class="col-sm-12 clearfix">
                    					...
                    					<!--	<input type="text" class="form-control" name="reply_text" id="reply_text" >-->
                    					    ...
                    					    <input type="hidden" id="mdkid" value="<?= md5($knowledge_details[0]['id']) ?>" >
                    					    <input type="hidden" name="skulid" id="skulid" value="<?= $school_id ?>" >
