    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                ...
                { ?>
                <div class="row">
                    <h2 class="col-lg-7 align-left heading" style="font-size:20px !important; flex: 0 0 66%;   max-width: 66%; "><?= ucwords($knowledge_details[0]['title']) ?></h2>
                    ...
                    <h2 class="col-lg-1 align-right"><a href="<?=$baseurl?>teacherknowledge/howitworks" title="Back"  class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></h2>
                </div>
                <?php }
                				...
                				<?php if (count($comments_details) != 0): ?>
                    				...
                    				<div class="comment clearfix">
                    					...
                    					<div class="comment-details">
                    						...
                    						<a class="tchrhiwcomm_reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1488') { echo $langlbl['title'] ; } } ?></a>
                    					</div>
                    					<div class="col-sm-12 clearfix">
                    					...
                    					<!-- reply form -->
                    					<form class="reply_form clearfix" id="tchrhowworkscomment_reply_form_<?php echo $comment['id'] ?>" data-id="<?php echo $comment['id']; ?>">
