                    ...
                    <div class="header">
                        ...
                        <ul class="header-dropdown">
                           ...
                           <!-- <li><a href="<?= $baseurl ?>knowledgeCenter/addlocaluniv" class="btn btn-info" >Add University</a></li>-->
                            <li><a href="<?= $baseurl ?>teacherknowledge" class="btn btn-info" ><span class="notranslate">Back</span></a></li>
                        </ul>
                    </div>
                    <div class="body">
                        <div class="row">
                                            ...
                                            <td>
                                                <p>
                                                    ...
                                                    <span style="width:13%; float:right;">
                                                        <a href="javascript:void(0);" data-id="<?= $uni['id'] ?>" data-uniname="<?= $uni['univ_name'] ?>" data-logo = "<?= $uni['logo'] ?>" class="btn btn-success localyoumecontactus" title="Contact Form"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '46') { echo $langlbl['title'] ; } } ?></a>
                                                    </span>
                                                </p>
                                                <?php 
