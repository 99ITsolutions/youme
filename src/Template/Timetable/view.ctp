...
<style>
    ...
    table>tbody>tr>th { border:1px solid #fff !important;}
                        ...
                        <div class="header">
                            <div class="row">
                                ...
                                <div class="col-md-6 align-right">
    					            <a href="<?= $baseurl?>timetable" title="Back" class="btn btn-info"><?= $lbl41 ?></a>
                                </div>
                            </div>
                        </div>
                        <div class="body">
                            <?php	echo $this->Form->create(false , ['url' => ['action' => 'view'] , 'method' => "post"  ]); ?>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">         
                                        ...
                                        <select class="form-control class" id="class_fil" name="class_fil" placeholder="Choose Class">
                                            ...
                                            foreach($class_details as $key => $val){
                                                ...
                                                if($show == 1) {
                                                ?>
                                                  <option  value="<?=$val['id']?>"  <?php if($val['id'] == $classid) { echo "selected"; } ?> ><?php echo $val['c_name'] ."-" . $val['c_section']."(" . $val['school_sections'].")";?> </option>
                                                <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="col-md-3">
                                    <button type="submit" class="btn btn-primary timefilterbtn" id="timefilterbtn" style="margin-top: 25px;"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '243') { echo $langlbl['title'] ; } } ?></button>
                                </div>
                            </div>
