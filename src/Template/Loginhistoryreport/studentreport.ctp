...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <div class=" row">
                    <h2 class="col-md-11 heading"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '2137') { echo $langlbl['title'] ; } } ?></h2>
                    ...
                    <div class="row col-md-12">
	                    ...
	                    <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control dobirthdatepicker" id="startdate" value="<?= $startdate1 ?>" data-date-format="dd-mm-yyyy" name="startdate"  required placeholder="Date<?php //foreach($lang_label as $langlbl) { if($langlbl['id'] == '1761') { echo $langlbl['title'] ; } } ?>*">
                            </div>
	                    </div>
	                    <!--<div class="col-sm-3">
                                ...
                                <tbody id="tracklog_body" class="modalrecdel"> 
                                    ...
                                    { 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="javascript:void(0);" data-toggle="modal"  data-str="student" data-d="<?=$d ?>" data-tchr="<?= $tchrnam ?>" data-id="<?= $value->id ?>" data-strtdate="<?= $startdate1 ?>" data-target="#myModal<?=$d;?>" title="Activities" class="btn btn-sm btn-success acttracker">Activities Tracker</a>
<!-- Modal -->
