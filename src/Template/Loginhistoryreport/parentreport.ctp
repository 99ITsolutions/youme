...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <div class=" row">
                    <h2 class="col-md-11 heading"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '2140') { echo $langlbl['title'] ; } } ?></h2>
            ...
            <div class="body" id="gen_pdf">
                ...
                <div class="row clearfix">
                    ...
                    <?php   echo $this->Form->create(false , ['url' => ['action' => 'parentreport'] , 'id' => "summaryreportform" , 'method' => "post"  ]);  ?>
                    ...
                    <div class="row col-md-12">
	                    <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <select class="form-control listparent" id="listparent" name="listparent" required>
                                    <option value="">Choose Parent</option>
                                    <?php
                                    foreach($par_details as $key => $val){
                                        if($parid != '' && ($val['parent_logindetails']['id'] == $parid))
                                        {
                                            $sel = "selected";
                                        }
                                        else
                                        ...
                                        <option  value="<?=$val['parent_logindetails']['id']?>" <?= $sel ?> ><?php echo $val['parent_logindetails']['parent_email'] ;?> </option>
                                    <?php }  ?>
                                </select> 
                            </div>
	                    </div>
                                ...
                                <tbody id="tracklog_body" class="modalrecdel"> 
                                    ...
                                    { 
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$myduration?></td>
                                            <td>
                                            <a href="javascript:void(0);" data-toggle="modal" data-id="<?= $value->id ?>" data-d="<?= $d ?>" data-target="#myModal<?=$d;?>" title="Activities" class="btn btn-sm btn-success acttracker">Activities Tracker</a>
<!-- Modal -->
            ...
            <div class="modal-body">
                <div class="row" style="margin-top: 25px;">
                    ...
                    <div class="col-md-12" style="margin-top: 30px;">
                        <table class="table table-bordered" id="trackact_table<?=$d;?>">
                            <thead>
                                <tr>
                                    <th>Time</th>
                                    <th>Page Name</th>
