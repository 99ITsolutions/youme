    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                    ...
                    <div class="row">
                        <h2 class="heading col-md-6 align-left" ><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '433') { echo $langlbl['title'] ; } } ?></h2>
                        <div class="col-md-6 align-right" >
                            <a href="javascript:void(0)"  title="Delete All" data-str= "School Notifications" data-url = "Notification/deleteallarchives"  id="deleteallnotify" class="btn btn-sm btn-success approvesclnotifys"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1532') { echo $langlbl['title'] ; } } ?> </a>
