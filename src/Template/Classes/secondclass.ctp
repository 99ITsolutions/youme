...
<td class="s12" dir="ltr"><?php if($period_first){ echo $period_first->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s14">
<?php  if($no = $first_period){ ?>
...
<td class="s12" dir="ltr"><?php if($period_first){ echo $period_first->max_marks * 4; }else{ echo "80"; } ?></td>
...
<td class="s12" dir="ltr"><?php if($period_first){ echo $period_first->max_marks * 12; }else{ echo "240"; } ?></td>
...
<td class="s12" dir="ltr"><?php if($period_second){ echo $period_second->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s14">
<?php  if($no = $second_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "manual exams" && $value->semester_name == "PREMIER TRIMESTRE"){ ?>
...
<td class="s12" dir="ltr"><?php if($period_second){ echo $period_second->max_marks * 4 ; }else{ echo "80"; } ?></td>
...
<?php } ?></td>
<td class="s14" style="border-top: 3px solid;"> <?php  if($no = $third_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "6ème PERIODE"){ ?>
...
<td class="s12" dir="ltr"  style="border-top: 3px solid;"><?php if($period_third){ echo $period_third->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14"  style="border-top: 3px solid;"><?php  if($no = $third_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "manual exams" && $value->semester_name == "TROISIEME TRIMESTRE"){ ?>
...
<?php } ?></td>
<td class="s12" dir="ltr"  style="border-top: 3px solid;"><?php if($period_third){ echo $period_third->max_marks * 4; }else{ echo "40"; } ?></td>
<td class="s14"  style="border-top: 3px solid;"><input type="text" name="" class="tens_section_one12"  style="font-weight: bold; width: 38px; border: none; color: red;"></td>
<td class="s12" dir="ltr"  style="border-top: 3px solid;"><?php if($period_third){ echo $period_third->max_marks * 12; }else{ echo "120"; } ?></td>
<td class="s15"  style="border-top: 3px solid;"><input type="text" name="" class="tens_section_one13"  style="font-weight: bold; width: 38px; border: none; color: red;"></td>
</tr>
<tr style="height: 20px">
...
<td class="s11" dir="ltr">Expression Orale</td>
<td class="s12" dir="ltr"><?php if(!empty($period_fourth)){ echo $period_fourth->max_marks; }else{ echo "20"; } ?></td>
<td class="s13">
...
<?php } ?>
<td class="s12" dir="ltr"><?php if($period_fourth){ echo $period_fourth->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s14">
<?php  if($no = $fourth_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "manual exams" && $value->semester_name == "PREMIER TRIMESTRE"){ ?>
...
<?php } ?>
<td class="s12" dir="ltr"><?php if($period_fourth){ echo $period_fourth->max_marks * 4; }else{ echo "80"; } ?></td>
...
<td class="s12" dir="ltr"><?php if($period_fourth){ echo $period_fourth->max_marks * 12; }else{ echo "240"; } ?></td>
...
<?php } ?></td>
<td class="s17" dir="ltr"><?php if($period_fifth){ echo $period_fifth->max_marks * 2 ; }else{ echo "60"; } ?></td>
<td class="s18">
<?php  if($no = $fifth_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "manual exams" && $value->semester_name == "PREMIER TRIMESTRE"){ ?>
...
<?php } ?></td>
<td class="s17" dir="ltr"><?php if($period_fifth){ echo $period_fifth->max_marks * 4 ; }else{ echo "120"; } ?></td>
...
<td class="s17" dir="ltr"><?php if($period_fifth){ echo $period_fifth->max_marks * 12 ; }else{ echo "360"; } ?></td>
...
<td class="s12" dir="ltr"><?php if(!empty($period_sixth)){ echo $period_sixth->max_marks; }else{ echo "10"; } ?></td>
<td class="s13">
<?php  if($no = $sixth_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "3ème PERIODE"){ ?>
...
<td class="s12" dir="ltr"><?php if($period_sevent){ echo $period_sevent->max_marks * 2 ; }else{ echo "20"; } ?></td>
<td class="s14">
<?php  if($no = $sevent_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "manual exams" && $value->semester_name == "PREMIER TRIMESTRE"){ ?>
...
<td class="s12" dir="ltr"><?php if($period_sevent){ echo $period_sevent->max_marks * 4 ; }else{ echo "40"; } ?></td>
...
<td class="s12" dir="ltr"><?php if(!empty($period_eight)){ echo $period_eight->max_marks; }else{ echo "20"; } ?></td>
<td class="s13">
...
<td class="s12" dir="ltr"><?php if($period_eight){ echo $period_eight->max_marks * 2 ; }else{ echo "40"; } ?></td>
...
<td class="s12" dir="ltr"><?php if($period_eight){ echo $period_eight->max_marks * 4 ; }else{ echo "80"; } ?></td>
...
<td class="s12" dir="ltr"><?php if($period_eight){ echo $period_eight->max_marks * 12 ; }else{ echo "240"; } ?></td>
...
<td class="s12" dir="ltr"><?php if($period_nine){ echo $period_nine->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s14">
<?php  if($no = $nine_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "manual exams" && $value->semester_name == "PREMIER TRIMESTRE"){ ?>
...
<td class="s12" dir="ltr"><?php if($period_nine){ echo $period_nine->max_marks * 4 ; }else{ echo "80"; } ?></td>
...
<td class="s12" dir="ltr"><?php if($period_nine){ echo $period_nine->max_marks * 12 ; }else{ echo "240"; } ?></td>
...
<td class="s17" dir="ltr"><?php if($period_ten){ echo $period_ten->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s18">
<?php  if($no = $ten_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "manual exams" && $value->semester_name == "PREMIER TRIMESTRE"){ ?>
...
<td class="s17" dir="ltr"><?php if($period_ten){ echo $period_ten->max_marks * 4 ; }else{ echo "80"; } ?></td>
...
<td class="s17" dir="ltr"><?php if($period_ten){ echo $period_ten->max_marks * 12 ; }else{ echo "240"; } ?></td>
...
<td class="s17" dir="ltr">Sciences d &#39;éveil</td>
...
<td class="s17" dir="ltr"><?php if($period_eleven){ echo $period_eleven->max_marks * 2 ; }else{ echo "40"; } ?></td>
<td class="s18">
<?php  if($no = $eleven_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "manual exams" && $value->semester_name == "PREMIER TRIMESTRE"){ ?>
...
<td class="s17" dir="ltr"><?php if($period_eleven){ echo $period_eleven->max_marks * 4 ; }else{ echo "80"; } ?></td>
...
<td class="s17" dir="ltr"><?php if($period_eleven){ echo $period_eleven->max_marks * 12 ; }else{ echo "240"; } ?></td>
...
<td class="s12" dir="ltr"><?php if(!empty($period_twelve)){ echo $period_twelve->max_marks; }else{ echo "10"; } ?></td>
<td class="s13">
<?php  if($no = $twelve_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "3ème PERIODE"){ ?>
...
var xy = parseInt($('.tens_section_eight9').val());
...
$('.eighth_section9').val(xy + yz );
  ...
  var xy = parseInt($('.tens_section_seven9').val());
var yz = parseInt($('.tens_section_eight9').val());
if(isNaN(yz)){ yz = 0; }
if(isNaN(xy))  { xy = 0; }
...
var xy = parseInt($('.forty_section2').val());
var yz = parseInt($('.thirty_section_one2').val());
var xx = parseInt($('.other_section2').val());
var yy = parseInt($('.eighth_section2').val());
var zz = parseInt($('.nineth_section2').val());
var aa = parseInt($('.thirty_section_third2').val());
if(isNaN(yz)){ yz = 0; }
if(isNaN(xy))  { xy = 0; }
if(isNaN(xx)){ xx = 0; }
if(isNaN(yy))  { yy = 0; }
if(isNaN(zz)){ zz = 0; }
if(isNaN(aa))  { aa = 0; }
$('.other_section_one2').val(xy + yz + xx + yy + zz + aa );
