                ...
                <div class="card">
                    <div class="header">
                        <div class=" row">
                            ...
                            <h2 class="col-md-1"><a href="<?= $baseurl ?>Readmissions" title="Back" class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></h2>
                        </div>
