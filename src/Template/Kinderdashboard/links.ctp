...
.bg-dash
{
    ...
    <div class="row container clearfix ">
        <div class="card ">
            <div class="header">
                <h2 class="heading">Virtual Class - (<?= $classname ?> (<?= $subjectname ?>))</h2>     
                 <ul class="header-dropdown">
                    <li><a href="<?= $baseurl?>kinderdashboard/virtualclass" title="Back" class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1394') { echo $langlbl['title'] ; } } ?></a></li>
                </ul>
