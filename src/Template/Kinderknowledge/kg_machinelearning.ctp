				...
				<div class="row">
				    ...
				    <ul class="header-dropdown">
                        ...
                        <li style="width:160px; padding:0px 10px">
                            <select class=" form-control community_filter" id="comm_filter" onchange="kinder_machinelearning_filter(this.value)">
                        ...
                        <li><a href="<?= $baseurl ?>Kinderknowledge/machinelearning" class="btn btn-info" ><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></li>
                    </ul>
                </div>
            </div>
            <div class="body">
                <div class="row col-sm-12" id="viewcommunity">
                        ...
                        <div class="col-sm-2 col_img">
                            <a href="<?=$baseurl?>Kinderknowledge/viewmachinelearning/<?php echo md5($content['id']) ?>" class="viewknow" >
