                    ...
                    <div class="body" id="knowledgecenter">
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="<?= $baseurl ?>Kinderknowledge/communityactivity/kinder">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a  href="<?= $baseurl ?>Kinderknowledge/communityactivity/primary">
                                <div class="card text-center bg-dash">
                                    <div class="body">
                                        <div class="p-15 text-light">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <a href="<?= $baseurl ?>Kinderknowledge/communityactivity/highscl">
                                <div class="card text-center bg-dash">
                                    <div class="body">
                                        <div class="p-15 text-light">
