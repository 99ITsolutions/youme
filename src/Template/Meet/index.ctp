                                ...
                                <tbody id="meetinglink_body" class="modalrecdel"> 
                                    ...
                                    foreach($link_details as $value)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td> https://you-me-globaleducation.org/school/conference?mid=<?= $value->meeting_id ?></td>
...
Join You-Me Live Meet Link<br><br>https://you-me-globaleducation.org/school/conference?mid=<?= $value->meeting_id ;?></p>
