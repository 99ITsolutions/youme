...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <h2 class="align-right"><a href="#" class="btn btn-success" onclick="closeCalendar()"><i class="fa fa-calendar"></i> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1215') { echo $langlbl['title'] ; } } ?></a></h2>
            </div>
