                ...
                <div class="row col-sm-12" id="viewcommunity">
                        ...
                        <div class="col-sm-3 col_img" style="height:215px !important">
                            <ul id="right_icon">
                                ...
                                <li> <a href="<?=$baseurl?>TeacherkinderApplication/view/<?php echo md5($content['id']) ?>" class="viewknow" ><i class="fa fa-eye"></i></a></li>
                            </ul>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header header">
                  <h6 class="title" id="defaultModalLabel">Add Content</h6>
