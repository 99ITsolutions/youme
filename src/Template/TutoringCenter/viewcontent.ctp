...
<div class="row clearfix">
        ...
        <div class="card">
            <div class="header">
                ...
                <div class="row">
                    ...
                    <!--<h2 class="col-lg-2 align-right"><a href="<?=$baseurl?>img/<?php echo $content_details[0]['links']?>" title="Download PDF" download class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1492') { echo $langlbl['title'] ; } } ?></a></h2>-->
                    ...
                    <h2 class="col-lg-1 align-right"><a href="<?=$baseurl?>tutoringCenter/subjects/<?= $content_details[0]['teacher_id'] ?>/<?= $content_details[0]['class_id'] ?>/<?= $content_details[0]['subject_id'] ?>" title="Back"  class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '41') { echo $langlbl['title'] ; } } ?></a></h2>
                </div>
                <?php } else {?>    
                <div class="row">
                ...
                <div class="row clearfix mb-4">
                    ...
                    if($content_details[0]['file_type'] == "pdf")
                    {
                        ...
                        <div class="col-sm-12 text-center" style="margin: auto;height: 500px;overflow: scroll;">
                            ...
                            <?php  } ?>
                        <!--<iframe src='http://docs.google.com/gview?embedded=true&url=https://you-me-globaleducation.org/school/img/<?php echo $content_details[0]['links']?>' height='600px' width="100%"></iframe>-->
                        </div>
                        <?php
                    }
                    ?>
                    <div class="col-sm-12 mt-3">
                      ...
                      <?php echo $this->Form->create(false , ['url' => ['action' => 'addcomment'] , 'id' => "comment_form" , 'enctype' => "multipart/form-data" , 'method' => "post"  ]); ?>
                        ...
                        <div class="col-sm-9" style="float:left">
                            ...
                            <input type="hidden" name="teacherid" id="teachr_id" value="<?= $content_details[0]['teacher_id'] ?>" >
                        ...
                        <?php if (count($comments_details) != 0): ?>
                            ...
                            <div class="comment clearfix">
                              ...
                              <div class="comment-details">
                                ...
                                <a class="scomm_reply-btn" href="javascript:void(0)" data-id="<?php echo $comment['id']; ?>"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1488') { echo $langlbl['title'] ; } } ?></a>
                              </div>
                              <div class="col-sm-12 clearfix">
                              ...
                              <!-- reply form -->
                              <div class="reply_form clearfix" id="comment_reply_form_<?php echo $comment['id'] ?>" data-id="<?php echo $comment['id']; ?>">
                              <!--  <input type="text" class="form-control" name="reply_text" id="reply_text" >-->
                                  ...
                                  <input type="hidden" name="skulid" id="skulid" value="<?= $content_details[0]['school_id'] ?>" >
                                  <input type="hidden" name="teachrid" id="teachr1id" value="<?= $content_details[0]['teacher_id'] ?>" >
                                <button class="btn btn-primary btn-xs pull-right ssubmit-reply"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1494') { echo $langlbl['title'] ; } } ?></button>
                              </div>
    ...
    $database = "youmeglo_globalweb";
                              ...
                              $replies = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `tutorial_comments` WHERE parent = '".$comment['id']."'")) ?>
