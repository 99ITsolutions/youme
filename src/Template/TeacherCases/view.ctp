                    ...
                    <div class="col-md-12">
                        <div class="widget-area no-padding blank" id="widget_box_sh" style="display:none">
							<div class="status-upload">
								<?php echo $this->Form->create(false , ['url' => ['action' => 'addmessage'] , 'id' => "tsendreply" , 'method' => "post"  ]); ?> 
    ...
    $(this).ajaxSubmit({
        ...
        success: function(response){
            ...
            if(response.result === "success" ){ 
                setTimeout(function(){ location.href = baseurl +"/TeacherCases/view/<?= base64_encode($id) ?>" ;  }, 1000);
