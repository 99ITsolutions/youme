                        ...
                        { 
    	                    ...
    	                    <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="card text-center bg-dash ">
                                    <a  class="colorBtn" href="<?=$baseurl?>teacherLibrary/library/<?= $empdtl['class']['id'] ?>/<?= $empdtl['subjects']['id'] ?>" class="meetinglist" >
	                    ...
	                    { 
    	                    ...
    	                    <div class="col-lg-3 col-md-6 col-sm-6 schedulemeeting">
                                <div class="card text-center bg-dash ">
                                    ...
                                    <a  class="colorBtn" href="<?=$baseurl?>teacherLibrary/library/<?= $gradeids[$key] ?>/<?= $subjectids[$key] ?>" class="meetinglist" >
                                        <div class="body" style="height:90px !important;">
                                            <div class="p-15 text-light teachersubdtlss">
