                    ...
                    <tr style="height: 40px">
                        ...
                        if($sclsctn == "maternelle" || $sclsctn == "creche") { 
                            ...
                            <td class="s13" id="recordermarks" style="width:37px;" dir="ltr">
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 8; } ?>">
                                <?php }
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 12; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(creche)" || $clsname == "1ère-(maternelle)") && ($subjectname == "Activités libres" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php } 
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 4; } ?>">
                                <?php }
                            ...
                            <td class="s13" id="recordermarks" style="width:37px;" dir="ltr">
                               <?php
                                ...
                                if(($clsname == "1ère-(creche)" || $clsname == "1ère-(maternelle)") && ( $subjectname == "Activités sensorielles" || $subjectname == "Activités de schémas corporels" || $subjectname == "Activités de vie pratique" || $subjectname == "Activités d'arts plastiques" || $subjectname == "Activités musicales" || $subjectname == "Activités de comportement" || $subjectname == "Activités Physiques" || $subjectname == "Activités de structuration spatiale" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss1" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 8; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(creche)" || $clsname == "1ère-(maternelle)") && ($subjectname == "Activités de langage" || $subjectname == "Activités exploratrices" || $subjectname == "Activités mathematiques" || $subjectname == "Activités mathématiques" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss1" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 12; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(creche)" || $clsname == "1ère-(maternelle)") && ($subjectname == "Activités libres" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss1" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php } 
                                
                                elseif(($clsname == "2ème-(maternelle)" || $clsname == "3ème-(maternelle)") && ( $subjectname == "Activités de schéma corporel" ||  $subjectname == "Activités de structuration spatiale" || $subjectname == "Activités d'orientation temporelle" || $subjectname == "Activités de latéralité"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss1" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 4; } ?>">
                                <?php }
                                elseif(($clsname == "2ème-(maternelle)" || $clsname == "3ème-(maternelle)") && ( $subjectname == "Activités musicales" || $subjectname == "Activités de vie pratiques" || $subjectname == "Activités d'arts plastiques" || $subjectname == "Activités Physiques" || $subjectname == "Activités sensorielles" || $subjectname == "Activités de comportement" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss1" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 8; } ?>">
                            ...
                            <td class="s13" id="recordermarks" style="width:37px;" dir="ltr">
                                ...
                                if(($clsname == "1ère-(creche)" || $clsname == "1ère-(maternelle)") && ( $subjectname == "Activités sensorielles" || $subjectname == "Activités de schémas corporels" || $subjectname == "Activités de vie pratique" || $subjectname == "Activités d'arts plastiques" || $subjectname == "Activités musicales" || $subjectname == "Activités de comportement" || $subjectname == "Activités Physiques" || $subjectname == "Activités de structuration spatiale" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss2" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 8; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(creche)" || $clsname == "1ère-(maternelle)") && ($subjectname == "Activités de langage" || $subjectname == "Activités exploratrices" || $subjectname == "Activités mathematiques" || $subjectname == "Activités mathématiques" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss2" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 12; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(creche)" || $clsname == "1ère-(maternelle)") && ($subjectname == "Activités libres" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss2" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php } 
                                
                                elseif(($clsname == "2ème-(maternelle)" || $clsname == "3ème-(maternelle)") && ( $subjectname == "Activités de schéma corporel" ||  $subjectname == "Activités de structuration spatiale" || $subjectname == "Activités d'orientation temporelle" || $subjectname == "Activités de latéralité"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss2" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 4; } ?>">
                                <?php }
                                elseif(($clsname == "2ème-(maternelle)" || $clsname == "3ème-(maternelle)") && ( $subjectname == "Activités musicales" || $subjectname == "Activités de vie pratiques" || $subjectname == "Activités d'arts plastiques" || $subjectname == "Activités Physiques" || $subjectname == "Activités sensorielles" || $subjectname == "Activités de comportement" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss2" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 8; } ?>">
                        ...
                        <?php } elseif($sclsctn == "primaire") {
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss5" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php }
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss5" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                <?php }
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss5" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 30; } ?>">
                                <?php }
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss5" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 5; } ?>">
                                <?php }
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                if(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)") && ($subjectname == "Expression Orale (FRANCAIS)" || $subjectname == "Expression Ecrite" || $subjectname == "Expression Orale (Langues Congolaises)" || $subjectname == "Problèmes" || $subjectname == "Numération" || $subjectname == "Opérations" || $subjectname == "Sciences d'éveil" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss3" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)") && ($subjectname == "Religion" || $subjectname == "Technologie" || $subjectname == "Ed. phys. & sports" || $subjectname == "Grandeurs" || $subjectname == "Vocabulaire" || $subjectname == "Formes géométriques" || $subjectname == "Ed civ & morale" || $subjectname == "Ed. Santé Env." || $subjectname == "Arts plastiques" || $subjectname == "Arts dramatiques" || $subjectname == "Init. Trav. Prod."))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss3" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)" || $clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Langues Congolaises"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss3" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 30; } ?>">
                                <?php }
                                ...
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Orth. & Rédaction"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss3" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 5; } ?>">
                                <?php }
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Problèmes" || $subjectname == "Technologie"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss3" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                ...
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Gram. Conj. Analyse" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss3" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 15; } ?>">
                                <?php }
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                if(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)") && ($subjectname == "Expression Orale (FRANCAIS)" || $subjectname == "Expression Ecrite" || $subjectname == "Expression Orale (Langues Congolaises)" || $subjectname == "Problèmes" || $subjectname == "Numération" || $subjectname == "Opérations" || $subjectname == "Sciences d'éveil" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss6" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)") && ($subjectname == "Religion" || $subjectname == "Technologie" || $subjectname == "Ed. phys. & sports" || $subjectname == "Grandeurs" || $subjectname == "Vocabulaire" || $subjectname == "Formes géométriques" || $subjectname == "Ed civ & morale" || $subjectname == "Ed. Santé Env." || $subjectname == "Arts plastiques" || $subjectname == "Arts dramatiques" || $subjectname == "Init. Trav. Prod."))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss6" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)" || $clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Langues Congolaises"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss6" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 30; } ?>">
                                <?php }
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Ed. Santé Env." || $subjectname == "Ed. Phys. & Sport" || $subjectname == "Ed. phys. & sports" ||  $subjectname == "Zoologie - botanique & Info." || $subjectname == "Numération" || $subjectname == "Opérations" || $subjectname == "Orth. phras. Ecrit. & réd" || $subjectname == "Exp. Orale - Récit. - Voc" || $subjectname == "Grammaire & Conj." || $subjectname == "Exp. Orale & Vocab." || $subjectname == "Religion" || $subjectname == "Histoire" || $subjectname == "Géographie" || $subjectname == "Ed. Santé & Env." || $subjectname == "Educ. civ & morale" || $subjectname == "Formes géométriques" || $subjectname == "Grandeurs" || $subjectname == "Arts plastiques" || $subjectname == "Arts dramatiques" || $subjectname == "Init. Trav. Prod."))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss6" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                ...
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Orth. & Rédaction"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss6" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 5; } ?>">
                                <?php }
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Problèmes" || $subjectname == "Technologie"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss6" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                ...
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Gram. Conj. Analyse" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss6" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 15; } ?>">
                                <?php }
                                elseif(($clsname == "5ème-(primaire)") && ($subjectname == "Rédaction" || $subjectname == "Ed. Phys. & Sport" || $subjectname == "Orthographe" || $subjectname == "Exp. Orale & Vocabulaire" || $subjectname == "Orth. & Rédaction" || $subjectname == "Gram. & Conj." || $subjectname == "Exp. Orale & Vocab." || $subjectname == "Religion" ||  $subjectname == "Technologie" || $subjectname == "Phys.- Zool.- Info" || $subjectname == "Histoire" || $subjectname == "Géographie" || $subjectname == "Ed. Santé Env." || $subjectname == "Ed. Civ. & Morale" || $subjectname == "Formes géométriques" || $subjectname == "Grandeurs" || $subjectname == "Numération" || $subjectname == "Opérations" || $subjectname == "Arts plastiques" || $subjectname == "Arts dramatiques" || $subjectname == "Init. Trav. Prod."  || $subjectname == "Rédac. Orthographe" || $subjectname == "Calligraphie"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss6" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                if(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)") && ($subjectname == "Expression Orale (FRANCAIS)" || $subjectname == "Expression Ecrite" || $subjectname == "Expression Orale (Langues Congolaises)" || $subjectname == "Problèmes" || $subjectname == "Numération" || $subjectname == "Opérations" || $subjectname == "Sciences d'éveil" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss7" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)") && ($subjectname == "Religion" || $subjectname == "Technologie" || $subjectname == "Ed. phys. & sports" || $subjectname == "Grandeurs" || $subjectname == "Vocabulaire" || $subjectname == "Formes géométriques" || $subjectname == "Ed civ & morale" || $subjectname == "Ed. Santé Env." || $subjectname == "Arts plastiques" || $subjectname == "Arts dramatiques" || $subjectname == "Init. Trav. Prod."))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss7" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)" || $clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Langues Congolaises"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss7" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 30; } ?>">
                                <?php }
                                ...
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Orth. & Rédaction"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss7" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 5; } ?>">
                                <?php }
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Problèmes" || $subjectname == "Technologie"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss7" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                ...
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Gram. Conj. Analyse" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss7" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 15; } ?>">
                                <?php }
                                elseif(($clsname == "5ème-(primaire)") && ($subjectname == "Rédaction" || $subjectname == "Ed. Phys. & Sport" || $subjectname == "Orthographe" || $subjectname == "Exp. Orale & Vocabulaire" || $subjectname == "Orth. & Rédaction" || $subjectname == "Gram. & Conj." || $subjectname == "Exp. Orale & Vocab." || $subjectname == "Religion" ||  $subjectname == "Technologie" || $subjectname == "Phys.- Zool.- Info" || $subjectname == "Histoire" || $subjectname == "Géographie" || $subjectname == "Ed. Santé Env." || $subjectname == "Ed. Civ. & Morale" || $subjectname == "Formes géométriques" || $subjectname == "Grandeurs" || $subjectname == "Numération" || $subjectname == "Opérations" || $subjectname == "Arts plastiques" || $subjectname == "Arts dramatiques" || $subjectname == "Init. Trav. Prod."  || $subjectname == "Rédac. Orthographe" || $subjectname == "Calligraphie"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss7" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                if(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)") && ($subjectname == "Expression Orale (FRANCAIS)" || $subjectname == "Expression Ecrite" || $subjectname == "Expression Orale (Langues Congolaises)" || $subjectname == "Problèmes" || $subjectname == "Numération" || $subjectname == "Opérations" || $subjectname == "Sciences d'éveil" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss9" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)") && ($subjectname == "Religion" || $subjectname == "Technologie" || $subjectname == "Ed. phys. & sports" || $subjectname == "Grandeurs" || $subjectname == "Vocabulaire" || $subjectname == "Formes géométriques" || $subjectname == "Ed civ & morale" || $subjectname == "Ed. Santé Env." || $subjectname == "Arts plastiques" || $subjectname == "Arts dramatiques" || $subjectname == "Init. Trav. Prod."))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss9" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)" || $clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Langues Congolaises"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss9" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 30; } ?>">
                                <?php }
                                ...
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Orth. & Rédaction"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss9" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 5; } ?>">
                                <?php }
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Problèmes" || $subjectname == "Technologie"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss9" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                ...
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Gram. Conj. Analyse" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss9" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 15; } ?>">
                                <?php }
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                if(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)") && ($subjectname == "Expression Orale (FRANCAIS)" || $subjectname == "Expression Ecrite" || $subjectname == "Expression Orale (Langues Congolaises)" || $subjectname == "Problèmes" || $subjectname == "Numération" || $subjectname == "Opérations" || $subjectname == "Sciences d'éveil" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss10" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)") && ($subjectname == "Religion" || $subjectname == "Technologie" || $subjectname == "Ed. phys. & sports" || $subjectname == "Grandeurs" || $subjectname == "Vocabulaire" || $subjectname == "Formes géométriques" || $subjectname == "Ed civ & morale" || $subjectname == "Ed. Santé Env." || $subjectname == "Arts plastiques" || $subjectname == "Arts dramatiques" || $subjectname == "Init. Trav. Prod."))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss10" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                <?php }
                                elseif(($clsname == "1ère-(primaire)" || $clsname == "2ème-(primaire)" || $clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Langues Congolaises"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss10" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 30; } ?>">
                                <?php }
                                ...
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Orth. & Rédaction"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss10" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 5; } ?>">
                                <?php }
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Problèmes" || $subjectname == "Technologie"  ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss10" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                ...
                                elseif(($clsname == "4ème-(primaire)" || $clsname == "3ème-(primaire)") && ($subjectname == "Gram. Conj. Analyse" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss10" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 15; } ?>">
                                <?php }
                        ...
                        <?php } else  { 
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss13" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php }
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss13" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 30; } ?>">
                                <?php }
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss13" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 40; } ?>">
                                <?php }
                                elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Français"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss13" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 50; } ?>">
                                <?php }
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss13" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 70; } ?>">
                                <?php }
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss13" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 100; } ?>">
                                <?php } 
                                ...
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss13" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 60; } ?>">
                                <?php } 
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                if($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Religion (1) (DOMAINE DES ARTS)" || $subjectname == "Education à la vie (1) (DOMAINE DES ARTS)" || $subjectname == "Histoire" || $subjectname == "Géométrie" || $subjectname == "Education Physique" || $subjectname == "Education à la vie (1)" || $subjectname == "Zoologie" ||  $subjectname == "Education Civique et Morale" || $subjectname == "Religion (1)"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss14" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php }
                                elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Arithmétique" || $subjectname == "Statistique" || $subjectname == "Anatomie" || $subjectname == "Botanique" || $subjectname == "Sciences Physiques" || $subjectname == "Technologie" || $subjectname == "Techn. d'Info. & Com. (TIC)"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss14" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                <?php }
                                 elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Anglais" || $subjectname == "Géographie"))
                                { ?>
                                ...
                                <?php }
                                 elseif(($clsname == "8ème-(cycle terminal de l'education de base (cteb))" || $clsname == "7ème-(cycle terminal de l'education de base (cteb))"  ) && ($subjectname == "Algèbre"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss14" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 40; } ?>">
                                <?php }
                                elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Français"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss14" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 50; } ?>">
                                <?php }
                                ...
                                elseif($clsname == "7ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Français"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss14" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 70; } ?>">
                                <?php }
                                ...
                                elseif(($clsname == "3ème année-(humanité pedagogie générale)" || $clsname == "4ème année-(humanité pedagogie générale)") && ($subjectname == "Pratique d'enseignement"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss14" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 100; } ?>">
                                <?php } 
                                elseif(($clsname == "4ème année-(humanité pedagogie générale)") && ($subjectname == "Religion" || $subjectname == "Education à la vie" || $subjectname == "Ed. civ & morale" || $subjectname == "Informatique (1)" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss14" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                ...
                                elseif(($clsname == "1ère année-(humanité commerciale & gestion)" || $clsname == "2ème année-(humanité commerciale & gestion)" || $clsname == "3ème année-(humanité commerciale & gestion)") && ($subjectname == "Comptabilité Générale"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss14" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 60; } ?>">
                                <?php } 
                                elseif(($clsname == "1ère année-(humanité commerciale & gestion)" || $clsname == "2ème année-(humanité commerciale & gestion)" || $clsname == "3ème année-(humanité commerciale & gestion)" || $clsname == "4ème année-(humanité commerciale & gestion)") && ($subjectname == "Pratique Professionnelle"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss14" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 100; } ?>">
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                if($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Religion (1) (DOMAINE DES ARTS)" || $subjectname == "Education à la vie (1) (DOMAINE DES ARTS)" || $subjectname == "Histoire" || $subjectname == "Géométrie" || $subjectname == "Education Physique" || $subjectname == "Education à la vie (1)" || $subjectname == "Zoologie" ||  $subjectname == "Education Civique et Morale" || $subjectname == "Religion (1)"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss12" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 40; } ?>">
                                <?php }
                                elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Arithmétique" || $subjectname == "Statistique" || $subjectname == "Anatomie" || $subjectname == "Botanique" || $subjectname == "Sciences Physiques" || $subjectname == "Technologie" || $subjectname == "Techn. d'Info. & Com. (TIC)"))
                                { ?>
                                ...
                                <?php }
                                 elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Anglais" || $subjectname == "Géographie"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss12" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 60; } ?>">
                                <?php }
                                 elseif(($clsname == "8ème-(cycle terminal de l'education de base (cteb))" || $clsname == "7ème-(cycle terminal de l'education de base (cteb))"  ) && ($subjectname == "Algèbre"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss12" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 80; } ?>">
                                <?php }
                                elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Français"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss12" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 100; } ?>">
                                <?php }
                                ...
                                elseif($clsname == "7ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Français"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss12" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 140; } ?>">
                                <?php }
                                ...
                                elseif(($clsname == "3ème année-(humanité pedagogie générale)" || $clsname == "4ème année-(humanité pedagogie générale)") && ($subjectname == "Pratique d'enseignement"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss12" <?= $readnlysts ?> value="">
                                <?php } 
                                elseif(($clsname == "4ème année-(humanité pedagogie générale)") && ($subjectname == "Religion" || $subjectname == "Education à la vie" || $subjectname == "Ed. civ & morale" || $subjectname == "Informatique (1)" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss12" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                ...
                                elseif(($clsname == "1ère année-(humanité commerciale & gestion)" || $clsname == "2ème année-(humanité commerciale & gestion)" || $clsname == "3ème année-(humanité commerciale & gestion)") && ($subjectname == "Comptabilité Générale"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss12" <?= $readnlysts ?> value="120">
                                <?php } 
                                elseif(($clsname == "1ère année-(humanité commerciale & gestion)" || $clsname == "2ème année-(humanité commerciale & gestion)" || $clsname == "3ème année-(humanité commerciale & gestion)" || $clsname == "4ème année-(humanité commerciale & gestion)") && ($subjectname == "Pratique Professionnelle"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss12" <?= $readnlysts ?> value="">
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                if($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Religion (1) (DOMAINE DES ARTS)" || $subjectname == "Education à la vie (1) (DOMAINE DES ARTS)" || $subjectname == "Histoire" || $subjectname == "Géométrie" || $subjectname == "Education Physique" || $subjectname == "Education à la vie (1)" || $subjectname == "Zoologie" ||  $subjectname == "Education Civique et Morale" || $subjectname == "Religion (1)"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss15" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php }
                                elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Arithmétique" || $subjectname == "Statistique" || $subjectname == "Anatomie" || $subjectname == "Botanique" || $subjectname == "Sciences Physiques" || $subjectname == "Technologie" || $subjectname == "Techn. d'Info. & Com. (TIC)"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss15" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                <?php }
                                 elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Anglais" || $subjectname == "Géographie"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss15" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 30; } ?>">
                                <?php }
                                 elseif(($clsname == "8ème-(cycle terminal de l'education de base (cteb))" || $clsname == "7ème-(cycle terminal de l'education de base (cteb))"  ) && ($subjectname == "Algèbre"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss15" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 40; } ?>">
                                <?php }
                                elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Français"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss15" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 50; } ?>">
                                <?php }
                                ...
                                elseif($clsname == "7ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Français"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss15" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 70; } ?>">
                                <?php }
                                ...
                                elseif(($clsname == "3ème année-(humanité pedagogie générale)" || $clsname == "4ème année-(humanité pedagogie générale)") && ($subjectname == "Pratique d'enseignement"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss15" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 100; } ?>">
                                <?php } 
                                elseif(($clsname == "4ème année-(humanité pedagogie générale)") && ($subjectname == "Religion" || $subjectname == "Education à la vie" || $subjectname == "Ed. civ & morale" || $subjectname == "Informatique (1)" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss15" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                ...
                                elseif(($clsname == "1ère année-(humanité commerciale & gestion)" || $clsname == "2ème année-(humanité commerciale & gestion)" || $clsname == "3ème année-(humanité commerciale & gestion)") && ($subjectname == "Comptabilité Générale"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss15" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 60; } ?>">
                                <?php } 
                                elseif(($clsname == "1ère année-(humanité commerciale & gestion)" || $clsname == "2ème année-(humanité commerciale & gestion)" || $clsname == "3ème année-(humanité commerciale & gestion)" || $clsname == "4ème année-(humanité commerciale & gestion)") && ($subjectname == "Pratique Professionnelle"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss15" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 100; } ?>">
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                if($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Religion (1) (DOMAINE DES ARTS)" || $subjectname == "Education à la vie (1) (DOMAINE DES ARTS)" || $subjectname == "Histoire" || $subjectname == "Géométrie" || $subjectname == "Education Physique" || $subjectname == "Education à la vie (1)" || $subjectname == "Zoologie" ||  $subjectname == "Education Civique et Morale" || $subjectname == "Religion (1)"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss16" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php }
                                elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Arithmétique" || $subjectname == "Statistique" || $subjectname == "Anatomie" || $subjectname == "Botanique" || $subjectname == "Sciences Physiques" || $subjectname == "Technologie" || $subjectname == "Techn. d'Info. & Com. (TIC)"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss16" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                <?php }
                                 elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Anglais" || $subjectname == "Géographie"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss16" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 30; } ?>">
                                <?php }
                                 elseif(($clsname == "8ème-(cycle terminal de l'education de base (cteb))" || $clsname == "7ème-(cycle terminal de l'education de base (cteb))"  ) && ($subjectname == "Algèbre"))
                                { ?>
                                ...
                                elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Français"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss16" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 50; } ?>">
                                <?php }
                                ...
                                elseif($clsname == "7ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Français"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss16" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 70; } ?>">
                                <?php }
                                ...
                                elseif(($clsname == "3ème année-(humanité pedagogie générale)" || $clsname == "4ème année-(humanité pedagogie générale)") && ($subjectname == "Pratique d'enseignement"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss16" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 100; } ?>">
                                <?php } 
                                elseif(($clsname == "4ème année-(humanité pedagogie générale)") && ($subjectname == "Religion" || $subjectname == "Education à la vie" || $subjectname == "Ed. civ & morale" || $subjectname == "Informatique (1)" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss16" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 10; } ?>">
                                ...
                                elseif(($clsname == "1ère année-(humanité commerciale & gestion)" || $clsname == "2ème année-(humanité commerciale & gestion)" || $clsname == "3ème année-(humanité commerciale & gestion)") && ($subjectname == "Comptabilité Générale"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss16" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 60; } ?>">
                                <?php } 
                                elseif(($clsname == "1ère année-(humanité commerciale & gestion)" || $clsname == "2ème année-(humanité commerciale & gestion)" || $clsname == "3ème année-(humanité commerciale & gestion)" || $clsname == "4ème année-(humanité commerciale & gestion)") && ($subjectname == "Pratique Professionnelle"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss16" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 100; } ?>">
                            ...
                            <td class="s13" style="width:37px;" dir="ltr">
                                ...
                                if($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Religion (1) (DOMAINE DES ARTS)" || $subjectname == "Education à la vie (1) (DOMAINE DES ARTS)" || $subjectname == "Histoire" || $subjectname == "Géométrie" || $subjectname == "Education Physique" || $subjectname == "Education à la vie (1)" || $subjectname == "Zoologie" ||  $subjectname == "Education Civique et Morale" || $subjectname == "Religion (1)"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss17" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 40; } ?>">
                                <?php }
                                elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Arithmétique" || $subjectname == "Statistique" || $subjectname == "Anatomie" || $subjectname == "Botanique" || $subjectname == "Sciences Physiques" || $subjectname == "Technologie" || $subjectname == "Techn. d'Info. & Com. (TIC)"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss17" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                <?php }
                                 elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Anglais" || $subjectname == "Géographie"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss17" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 60; } ?>">
                                <?php }
                                 elseif(($clsname == "8ème-(cycle terminal de l'education de base (cteb))" || $clsname == "7ème-(cycle terminal de l'education de base (cteb))"  ) && ($subjectname == "Algèbre"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss17" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 80; } ?>">
                                <?php }
                                elseif($clsname == "8ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Français"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss17" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 100; } ?>">
                                <?php }
                                ...
                                elseif($clsname == "7ème-(cycle terminal de l'education de base (cteb))" && ($subjectname == "Français"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss17" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 140; } ?>">
                                <?php }
                                ...
                                elseif(($clsname == "3ème année-(humanité pedagogie générale)" || $clsname == "4ème année-(humanité pedagogie générale)") && ($subjectname == "Pratique d'enseignement"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss17" <?= $readnlysts ?> value="">
                                <?php } 
                                elseif(($clsname == "4ème année-(humanité pedagogie générale)") && ($subjectname == "Religion" || $subjectname == "Education à la vie" || $subjectname == "Ed. civ & morale" || $subjectname == "Informatique (1)" ))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss17" <?= $readnlysts ?> value="<?php if($recmaxmrksval != "") { echo $recmaxmrksval; } else { echo 20; } ?>">
                                ...
                                elseif(($clsname == "1ère année-(humanité commerciale & gestion)" || $clsname == "2ème année-(humanité commerciale & gestion)" || $clsname == "3ème année-(humanité commerciale & gestion)") && ($subjectname == "Comptabilité Générale"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss17" <?= $readnlysts ?> value="120">
                                <?php } 
                                elseif(($clsname == "1ère année-(humanité commerciale & gestion)" || $clsname == "2ème année-(humanité commerciale & gestion)" || $clsname == "3ème année-(humanité commerciale & gestion)" || $clsname == "4ème année-(humanité commerciale & gestion)") && ($subjectname == "Pratique Professionnelle"))
                                { ?>
                                    <input type="text" class="inputtext" data-reqid="<?= $reqid ?>" id="maxmarkss17" <?= $readnlysts ?> value="">
                        ...
                        ?>
                            ...
                            <tr style="height: 20px">
                                ...
                                if($sclsctn == "maternelle" || $sclsctn == "creche") { 
                                    ...
                                    <?php if(!empty($assesment3)) {
                                        ...
                                        for($j=0; $j<5; $j++) { ?>
                                            <td class="s6" dir="ltr"></td>
                                    <?php } } ?>
                                    <td class="s13" style="width:37px; background:#cccccc;" dir="ltr"><?= array_sum($ob3) ?>
                                    <input type="hidden" value="<?= array_sum($ob3) ?>" name="growvalusthir" id="growvalusthir<?=$i;?>"></td>
                                    <td class="s13" style="width:37px;" dir="ltr">
                                        <?php if(!empty($exams3)) {
                                            foreach($exams3 as $key)
                                            {
                                ...
                                <?php } elseif($sclsctn == "primaire") { 
                                    ...
                                    <td class="s13" style="width:37px; background:#cccccc;" dir="ltr">
                                        <?= array_sum($ob3) ?>
                                        <input type="hidden" value="<?= array_sum($ob3) ?>" name="growvalusthir" id="growvalusthir<?=$i;?>">
                                    </td>
                                    <td class="s13" style="width:37px;" dir="ltr">
                                        <?php if(!empty($marksrecord)) 
                                        {
                                    ...
                                    <td class="s13" style="width:37px; background:#cccccc;" dir="ltr">
                                        <?= array_sum($ob4) ?>
                                        <input type="hidden" value="<?= array_sum($ob4) ?>" name="growvalusfor" id="growvalusfor<?=$i;?>">
                                    </td>
                                    <td class="s13" style="width:37px;" dir="ltr">
                                        <?php if(!empty($marksrecord)) 
                                        {
                                    ...
                                    <td class="s13" style="width:37px; background:#cccccc;" dir="ltr">
                                        <?= array_sum($ob5) ?>
                                        <input type="hidden" value="<?= array_sum($ob5) ?>" name="growvalusfive" id="growvalusfive<?=$i;?>"></td>
                                    </td>
                                    <td class="s13" style="width:37px;" dir="ltr">
                                        <?php if(!empty($marksrecord)) 
                                        {
                                    ...
                                    <?php if(!empty($assesment6)) {
                                        ...
                                        <?php } } else {
                                            ...
                                            foreach($assesment6 as $key)
                                            {
                                                ...
                                                $ob6[] = $obmrks;
                                            ?>
                                                <td class="s6" dir="ltr"><?php  $obmrks ?></td>
                                        <?php }
                                            for($k=$ass6;$k<4;$k++)    
                                            { ?>
                                                <td class="s6" dir="ltr"></td>
                                    ...
                                    <td class="s13" style="width:37px; background:#cccccc;" dir="ltr">
                                        <?= array_sum($ob6) ?>
                                        <input type="hidden" value="<?= array_sum($ob6) ?>" name="growvalussix" id="growvalussix<?=$i;?>"></td>
                                    </td>
                                    <td class="s13" style="width:37px;" dir="ltr">
                                        <?php if(!empty($marksrecord)) 
                                        {
                                ...
                                <?php } else { 
                                    ...
                                    <?php if(!empty($assesment4)) {
                                        ...
                                        for($j=0; $j<4; $j++) { ?>
                                            <td class="s13" style="width:37px;" dir="ltr"></td>
                                    <?php } } ?>
                                    <td class="s13" style="width:37px; background:#cccccc;" dir="ltr"><?= array_sum($ob4) ?>
                                     <input type="hidden" value="<?= array_sum($ob4) ?>" name="growvalusfor" id="growvalusfor<?=$i;?>" >
                                    </td>
                                    <td class="s13" style="width:37px;" dir="ltr">
                                        <?php if(!empty($marksrecord)) 
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">  
                            <label>Choose Trimestre</label>
                            <?php if($sclsctn == "cycle terminal de l'education de base (cteb)")
                            {
                                $sclsctn = "cteb";
                            } ?>
                            <select name="trimestre"  class="form-control exam_type" onchange="getperiode(this.value, '<?= $sclsctn ?>')">
                                <option value="">CHOOSE TRIMESTRE</option>
                            <?php if($sclsctn == "maternelle" || $sclsctn == "creche") { ?>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">  
                            <label>Choose Periode</label>
                            <select name="periode" id="choseperiode" class="form-control exam_type">
...
<?php if($sclsctn == "maternelle" || $sclsctn == "creche") { ?>
    ...
    for(i=1;i<totalstudent;i++){
            ...
            $.ajax({
                ...
                data:{'marks' : Sesionendmarks, 'stid' : stid, 'subid' : subid, 'clsid' :clsid, 'subname':subname, 'semname':semname},
...
<?php } elseif($sclsctn == "primaire") {  ?>
   ...
   //alert(G5marks);
    ...
    for(i=1;i<totalstudent;i++){
            var GHSDmarks = $("#growvalusfive"+i).val();
            if(GHSDmarks > 0){
                var G5H5avg = H5marks/G5marksec;
                var Sesionendmarks = Math.round(GHSDmarks * G5H5avg);
                var newpmarks = $("#p5marks"+i).val(Sesionendmarks);
    ...
    var totalstudent = $("#totalstucount").val();
    for(i=1;i<totalstudent;i++){
            var GHSDmarks = $("#growvalussix"+i).val();
            if(GHSDmarks > 0){
                var G5H5avg = H5marks/G5marksec;
                var Sesionendmarks = Math.round(GHSDmarks * G5H5avg);
                var newpmarks = $("#p6marks"+i).val(Sesionendmarks);
