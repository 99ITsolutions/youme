...
<td class="s12" dir="ltr"  style="border-top: 3px solid;">20</td>
<td class="s14"  style="border-top: 3px solid;"><?php  if($no = $third_period){ ?>
<?php foreach($no as $key => $value) { if($value->period_name == "manual exams" && $value->semester_name == "TROISIEME TRIMESTRE"){ ?>
...
<?php } ?></td>
<td class="s12" dir="ltr"  style="border-top: 3px solid;">40</td>
...
<td class="s12" dir="ltr"  style="border-top: 3px solid;">120</td>
