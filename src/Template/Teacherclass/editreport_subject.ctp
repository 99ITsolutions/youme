...
<div class="text-center" style="margin-bottom: 20px;font-size: 16px;">
 ...
 ?>   
  ...
  <input type="radio"  name="status" value="1" style="width: auto;height: auto;" <?php if($report_marks['status'] == 0){?> checked="checked" <?php } ?>> <?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1981') { echo $langlbl['title'] ; } } ?>
