        ...
        <div class="card">
            <div class="header">
                ...
                <ul class="header-dropdown">
	                <li><a href="<?=$baseurl?>TeacherMessages/add" title="Add" class="btn btn-sm btn-success"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1380') { echo $langlbl['title'] ; } } ?></a></li>
                                    ...
                                    foreach($message_details as $value){
                                        ...
                                        <tr>
                                           <td class="width45">
                                            ...
                                            <td>
                                                <span <?= $read ?>><?=$value['sender']." (". $value['email'].")"?></span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="<?=$baseurl?>TeacherMessages/view/<?= base64_encode($value['id']) ?>"  class="btn btn-sm btn-outline-secondary" title="View"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        $n++;
