...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <h1 style="font-size:24px"><a href="<?=$baseurl?>KinderMessages" title="Add" class="btn btn-sm btn-default" style="float:right"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1370') { echo $langlbl['title'] ; } } ?></a>  <?php if(count($all_messages) > 1){ ?><b>Re: </b><?php } ?><?= $get_messages->subject ?></h1>
            </div>
    ...
    $(this).ajaxSubmit({
        ...
        success: function(response){
            ...
            if(response.result === "success" ){ 
                setTimeout(function(){ location.href = baseurl +"/KinderMessages/view/<?= base64_encode($id) ?>" ;  }, 1000);
