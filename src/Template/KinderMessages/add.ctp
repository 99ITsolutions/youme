...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <a href="<?=$baseurl?>KinderMessages" title="<?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1370') { echo $langlbl['title'] ; } } ?>" class="btn btn-sm btn-success" style="float:right"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '1370') { echo $langlbl['title'] ; } } ?></a>            
            </div>
            <div class="body">
                <?php	echo $this->Form->create(false , ['url' => ['action' => 'addmessage'] , 'id' => "send_message1" , 'method' => "post"  ]); ?>
                    <div class="row ">
                        <div class="col-sm-12">
...
$("#send_message1").submit(function(e){
    e.preventDefault();
    ...
    $(this).ajaxSubmit({
        ...
        success: function(response){
            ...
            if(response.result === "success" ){ 
                $("#msgsendsuccess").html("Message sent succesfully!") ;
                $("#msgsendsuccess").fadeIn();
                setTimeout(function(){ location.href = baseurl +"/KinderMessages/" ;  }, 1000);
