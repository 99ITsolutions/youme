...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <div class=" row">
                    <h2 class="col-md-11 heading"><?php foreach($lang_label as $langlbl) { if($langlbl['id'] == '2142') { echo $langlbl['title'] ; } } ?></h2>
                    ...
                    <div class="row col-md-12">
	                    <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <select class="form-control listsclsub" id="listsclsub" name="listsclsub" required>
                                    <option value="">Choose Sub-admin</option>
                                    <?php
                                    foreach($subsuper_details as $key => $val){
                                        if($subid != '' && ($val['id'] == $subid))
                                        {
                                            $sel = "selected";
                                        }
                                        else
