...
class StudyguideController  extends AppController
{
    ...
    {   
		...
		/*	$retrieve_subexams = $submit_exams_table->find()->select(['status', 'passcode', 'id', 'upload_exams', 'file_type'])->where(['md5(student_id)' => $stid , 'exam_id' => $retrieve_examass[$key]['id'] ])->toArray() ;
        ...
        $this->set("content_details", $retrieve_examass); 
