...
class StudentAttendanceController  extends AppController
{
     ...
     */
            ...
            {   
                ...
                $retrieve_attendace = $attendance_table->find()->select(['attendence.id' , 'attendence.c_name', 'attendence.section','attendence.attendence' , 'attendence.att_date', 'attendence.roll_num', 'student.s_name'])->join(['student' => 
                        [
                        'table' => 'student',
                        'type' => 'LEFT',
                        'conditions' => 'student.adm_no = attendence.adm_no'
                    ]])->where([ 'attendence.school_id '=> $school_id, 'md5(student.id)' => $stdid ])->toArray() ;
                
                $this->set("attendace_details", $retrieve_attendace); 
