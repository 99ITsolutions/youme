 ...
 */
class TeacherPostController extends AppController
{
    ...
    {  
		...
		if(!empty($session_id) && !empty($compid))
		{
    ...
    public function replycomments()
    {
        if ($this->request->is('ajax') && $this->request->is('post') )
        {
            ...
            if(!empty($tid))
            {
                ...
                $discussion->teacher_id = $tid;
                $discussion->school_id = $compid;
                $discussion->class_id = $this->request->data('gradeid');
                $discussion->subject_id = $this->request->data('subid');
                $discussion->added_by = "teacher";
