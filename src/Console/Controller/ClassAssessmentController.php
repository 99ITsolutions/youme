...
class ClassAssessmentController  extends AppController
{
    ...
    {   
        ...
        $retrive_asstitles = $exams_assessments_table->find()->select([ 'id' , 'title'])->where(['subject_id' => $subjectid, 'class_id' => $classid , 'type' => 'Assessment'])->toArray() ;
        if(!empty($_POST))
        {
        ...
        {
            $retrive_examids = $exams_assessments_table->find()->select([ 'id'])->where(['subject_id' => $subjectid, 'class_id' => $classid , 'type' => 'Assessment'])->toArray() ;
        }
        $exams_students = [];
